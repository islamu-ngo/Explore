...
public sealed class ProgramTests
{
    ...
    public async Task UnknownCommandReturnsStableBoundedUsageError()
    {
        ...
        await Assert.That(output.ToString()).IsEqualTo("unknown_command: supported commands are prepare, verify-candidate, tag-message, verify-tag, verify-main, verify-baseline, and verify-tools" + Environment.NewLine);
    }
