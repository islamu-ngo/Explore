<!-- ABOUTME: Configuration guide for the interactive Scalar Test it runner in GitBook API docs. -->
<!-- ABOUTME: Covers authentication schemes, server URLs, CORS requirements, and GitBook proxy setup. -->
