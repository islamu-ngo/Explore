<!-- ABOUTME: Comprehensive tag syntax and code examples for GitBook custom blocks. -->
<!-- ABOUTME: Covers tabs, steppers, hints, expandable details, updates, card tables, and embeds. -->
