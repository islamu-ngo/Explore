<!-- ABOUTME: Field-by-field schema reference for gitbook-manifest.yaml in developer integrations. -->
<!-- ABOUTME: Documents integration identity, permissions, blocks, configuration forms, and secrets. -->
