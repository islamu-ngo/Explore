<!-- ABOUTME: Reference for GitBook-flavored markdown, diagrams, math, and asset handling. -->
<!-- ABOUTME: Covers GitHub Flavored Markdown differences, Mermaid syntax, LaTeX math, and SVGs. -->
