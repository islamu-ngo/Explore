<!-- ABOUTME: Reference guide for GitBook page frontmatter, layout flags, and variables. -->
<!-- ABOUTME: Covers description quoting rules, icons, wide layouts, covers, and expression syntax. -->
