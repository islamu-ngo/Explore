<!-- ABOUTME: Worked examples and payloads for SiteCustomizationSettings in GitBook. -->
<!-- ABOUTME: Covers theme presets, light/dark colors, custom fonts, logos, headers, and footers. -->
...
- **Per-page layout** (cover, table of contents visibility) — set in page frontmatter; see [content-authoring.md](content-authoring.md) and [frontmatter.md](frontmatter.md).
