<!-- ABOUTME: Information architecture heuristics for designing multi-space GitBook documentation sites. -->
<!-- ABOUTME: Guides audience partitioning, space vs section decisions, page depth, and structure sign-offs. -->
