<!-- ABOUTME: API and event reference for @gitbook/runtime in developer integrations. -->
<!-- ABOUTME: Covers createIntegration, createComponent, createOAuthHandler, context.environment, and events. -->
