...
public class HandlerValidatorPairingTests
{
    ...
    private static string ReadHandlerSource(Type handlerType)
    {
        ...
        var candidates = Directory.EnumerateFiles(Path.Combine(SourceRoot, "src", "Explore.Application"), "*.cs", SearchOption.AllDirectories)
    ...
    private static string LocateSourceRoot()
    {
        ...
        while (directory is not null)
        {
            if (File.Exists(Path.Combine(directory.FullName, "Explore.slnx")) &&
                (Directory.Exists(Path.Combine(directory.FullName, "Explore.Application")) ||
                 Directory.Exists(Path.Combine(directory.FullName, "src", "Explore.Application"))))
            {
