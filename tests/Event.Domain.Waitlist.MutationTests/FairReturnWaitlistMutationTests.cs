// ABOUTME: Kills mutations in fair-return equivalence, lifecycle transitions, leases, and retry bounds.
// ABOUTME: Uses valid Domain factories so tests exercise the same invariants as PostgreSQL orchestration.

using Explore.Domain;

namespace Explore.Domain.Waitlist.MutationTests;

public sealed class FairReturnWaitlistMutationTests
{
