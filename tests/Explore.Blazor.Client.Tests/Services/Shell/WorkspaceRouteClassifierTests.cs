...
public sealed class WorkspaceRouteClassifierTests
{
    ...
    [Arguments("/settings?section=appearance", "settings")]
    [Arguments("https://example.test/settings?section=appearance", "settings")]
    ...
    [Arguments("/admin/instance/settings", "events")]
    [Arguments("/admin/tenant/settings", "events")]
    [Arguments("/admin/organization/123/settings", "events")]
    [Arguments("/admin/group/123/settings", "events")]
