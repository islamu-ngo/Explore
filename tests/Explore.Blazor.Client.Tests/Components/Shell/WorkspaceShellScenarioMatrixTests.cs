...
public sealed class WorkspaceShellScenarioMatrixTests
{
    ...
    [
        ...
        new("tenant-admin-revoked-studio", "tenant-admin", PublicExperienceMode.DiscoveryCentric, true, false, true, "MultiTenant", [TenantScope], "/studio", "studio", "Events", ["Events", "AI", "Settings"], ["/settings/tenant"], "Advanced Search", "events", "events", "tablet-768"),
        ...
        new("multi-role-single-tenant", "multi-role", PublicExperienceMode.DiscoveryCentric, true, true, true, "SingleTenant", [OrganizationScope, GroupScope, TenantScope, InstanceScope], "/ai", "ai", "Studio", ["Events", "Studio", "AI", "Settings"], [OrganizationRoute, GroupRoute, "/settings/tenant", "/settings/instance"], "Advanced Search", "ai", "ai", "desktop-1920")
    ];
