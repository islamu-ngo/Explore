// ABOUTME: EF Core model snapshot for API-hosted TickerQ operational persistence.
// ABOUTME: Tracks scheduler-only TimeTicker and CronTicker tables in the ticker schema.
...
{
    [DbContext(typeof(ApiTickerQDbContext))]
    partial class ApiTickerQDbContextModelSnapshot : ModelSnapshot
    {
