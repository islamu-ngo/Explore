// ABOUTME: EF Core migration creating TickerQ operational tables in the ticker schema.
// ABOUTME: Keeps scheduler persistence separate from PostgreSQL EmailDispatch business state.
...
namespace Explore.API.Migrations.TickerQ
{
    /// <inheritdoc />
