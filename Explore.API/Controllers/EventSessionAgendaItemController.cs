...
namespace Explore.API.Controllers
{
    ...
    public class EventSessionAgendaItemController : ControllerBase
    {
        ...
        [AllowAnonymous]
        public async Task<ActionResult<EventSessionAgendaItemDto>> GetById(Guid id)
        {
            var agendaItem = await _mediator.Send(new GetEventSessionAgendaItemDetailsRequest { Id = id });
        ...
        [AllowAnonymous]
        public async Task<ActionResult<List<EventSessionAgendaItemListDto>>> GetBySession(Guid sessionId)
        {
            var agendaItems = await _mediator.Send(new GetAgendaItemsBySessionRequest { EventSessionId = sessionId });
            return Ok(agendaItems);
        }
        ...
        [Authorize]
        public async Task<ActionResult<BaseCommandResponse<Guid>>> Create([FromBody] CreateEventSessionAgendaItemDto agendaItem)
        {
        ...
        [Authorize]
        public async Task<ActionResult<BaseCommandResponse<Guid>>> Update(Guid id, [FromBody] UpdateEventSessionAgendaItemDto agendaItem)
        {
            if (id != agendaItem.Id)
            {
