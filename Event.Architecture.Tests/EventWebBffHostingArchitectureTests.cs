...
public sealed class EventWebBffHostingArchitectureTests
{
    ...
    private static readonly string BffHostingRoot = Path.Combine(RepoRoot, "Event.Web.BffHosting");
    ...
    {
        var extensionPath = Path.Combine(RepoRoot, "Explore.Blazor", "Extensions", "YarpProxyExtensions.cs");
