...
public sealed class WebhooksControllerTests
{
    ...
    private WebhooksController CreateController(string providerSubject)
    {
        ...
        return new WebhooksController(_mediator, _tenantContext, _consumerAssembler, _endpointAssembler)
        {
    ...
    private WebhookEndpointDto CreateEndpointDto(int statusId = 1, string statusName = "Active")
    {
        var eventTypeId = Guid.CreateVersion7();
