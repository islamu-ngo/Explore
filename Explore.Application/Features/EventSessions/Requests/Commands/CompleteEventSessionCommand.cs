// ABOUTME: MediatR command for completing an event session through an explicit lifecycle transition.
...
public sealed class CompleteEventSessionCommand : IEventSessionLifecycleTransitionCommand
{
