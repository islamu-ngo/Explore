...
public class CreateEventSessionGroupRequestDtoValidator : AbstractValidator<CreateEventSessionGroupRequestDto>
{
    public CreateEventSessionGroupRequestDtoValidator(
