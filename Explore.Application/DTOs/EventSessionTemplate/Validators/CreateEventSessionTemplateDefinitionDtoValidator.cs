...
public class CreateEventSessionTemplateDefinitionDtoValidator : AbstractValidator<CreateEventSessionTemplateDefinitionDto>
{
    public CreateEventSessionTemplateDefinitionDtoValidator()
    {
        ...
        RuleForEach(x => x.Options)
            .SetValidator(new CreateEventSessionTemplateOptionDtoValidator());
    ...
    private static bool HaveMatchingDefaultShape(CreateEventSessionTemplateDefinitionDto dto)
    {
