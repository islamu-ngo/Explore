...
public class CreateEventSessionTemplateOptionDtoValidator : AbstractValidator<CreateEventSessionTemplateOptionDto>
{
    public CreateEventSessionTemplateOptionDtoValidator()
    {
