...
public class CreateEventTemplateDefinitionDtoValidator : AbstractValidator<CreateEventTemplateDefinitionDto>
{
    public CreateEventTemplateDefinitionDtoValidator()
    {
        ...
        RuleForEach(x => x.Options)
            .SetValidator(new CreateEventTemplateOptionDtoValidator());
    ...
    private static bool HaveMatchingDefaultShape(CreateEventTemplateDefinitionDto dto)
    {
