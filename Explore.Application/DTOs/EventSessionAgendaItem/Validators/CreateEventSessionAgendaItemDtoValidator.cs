...
{
    public class CreateEventSessionAgendaItemDtoValidator : AbstractValidator<CreateEventSessionAgendaItemDto>
    {
        private readonly IEventSessionRepository _eventSessionRepository;
        private readonly ILocationRepository _locationRepository;

        public CreateEventSessionAgendaItemDtoValidator(
