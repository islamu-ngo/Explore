// ABOUTME: FluentValidation rules for UpdateEventAgendaItemDto enforcing event ownership and time ordering.
...
{
    public UpdateEventAgendaItemDtoValidator(IEventRepository eventRepository)
    {
        RuleFor(d => d.Id)
