...
public class MappingProfile : Profile
{
    public MappingProfile()
    {
        ...
        // ============================================
        // TENANT NAVIGATION LINK MAPPINGS
        // ============================================
        ...
        CreateMap<CreateEventTemplateDto, EventTemplate>()
            ...
            .ForMember(dest => dest.DeletedAt, opt => opt.Ignore())
            .ForMember(dest => dest.DeletedBy, opt => opt.Ignore());
        CreateMap<UpdateEventTemplateDto, EventTemplate>()
            .ForMember(dest => dest.TenantId, opt => opt.Ignore())
            .ForMember(dest => dest.Tenant, opt => opt.Ignore())
            .ForMember(dest => dest.EventType, opt => opt.Ignore())
            .ForMember(dest => dest.Definitions, opt => opt.Ignore())
        ...
        // ============================================
        // EVENT TEMPLATE DEFINITION MAPPINGS
        // ============================================
        ...
        // ============================================
        // EVENT CUSTOM PROPERTY DEFINITION MAPPINGS (Runtime)
        // ============================================
        ...
        CreateMap<CreateEventCustomPropertyDefinitionDto, EventCustomPropertyDefinition>()
            ...
            .ForMember(dest => dest.DeletedAt, opt => opt.Ignore())
            .ForMember(dest => dest.DeletedBy, opt => opt.Ignore());
        CreateMap<UpdateEventCustomPropertyDefinitionDto, EventCustomPropertyDefinition>()
            .ForMember(dest => dest.TenantId, opt => opt.Ignore())
            .ForMember(dest => dest.Tenant, opt => opt.Ignore())
            .ForMember(dest => dest.Event, opt => opt.Ignore())
            .ForMember(dest => dest.SourceTemplate, opt => opt.Ignore())
        ...
        // ============================================
        // EVENT CUSTOM PROPERTY VALUE MAPPINGS
        // ============================================
        ...
        // ============================================
        // EVENT SESSION TEMPLATE MAPPINGS
        // ============================================
        ...
        CreateMap<CreateEventSessionTemplateDto, EventSessionTemplate>()
            ...
            .ForMember(dest => dest.DeletedAt, opt => opt.Ignore())
            .ForMember(dest => dest.DeletedBy, opt => opt.Ignore());
        CreateMap<UpdateEventSessionTemplateDto, EventSessionTemplate>()
            .ForMember(dest => dest.TenantId, opt => opt.Ignore())
            .ForMember(dest => dest.Tenant, opt => opt.Ignore())
            .ForMember(dest => dest.EventTemplate, opt => opt.Ignore())
            .ForMember(dest => dest.Definitions, opt => opt.Ignore())
        ...
        // ============================================
        // EVENT SESSION TEMPLATE DEFINITION MAPPINGS
        // ============================================
        ...
        // ============================================
        // EVENT SESSION CUSTOM PROPERTY DEFINITION MAPPINGS
        // ============================================
        ...
        CreateMap<CreateEventSessionCustomPropertyDefinitionDto, EventSessionCustomPropertyDefinition>()
            ...
            .ForMember(dest => dest.DeletedAt, opt => opt.Ignore())
            .ForMember(dest => dest.DeletedBy, opt => opt.Ignore());
        CreateMap<UpdateEventSessionCustomPropertyDefinitionDto, EventSessionCustomPropertyDefinition>()
            .ForMember(dest => dest.TenantId, opt => opt.Ignore())
            .ForMember(dest => dest.Tenant, opt => opt.Ignore())
            .ForMember(dest => dest.EventSession, opt => opt.Ignore())
            .ForMember(dest => dest.SourceTemplate, opt => opt.Ignore())
        ...
        // ============================================
        // EVENT SESSION CUSTOM PROPERTY VALUE MAPPINGS
        // ============================================
