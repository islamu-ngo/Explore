...
| `MINIO_API_PORT` | integration | public | optional | deployment | dotenv, compose |
| `MINIO_CONSOLE_PORT` | integration | public | optional | deployment | dotenv, compose |
| `CERBOS_HTTP_PORT` | deployment | public | optional | deployment | dotenv, compose, startup |
| `CERBOS_GRPC_PORT` | deployment | public | optional | deployment | dotenv, compose, startup |
| `SVIX_HTTP_PORT` | integration | public | optional | deployment | dotenv, compose |
| `WEBLATE_HTTP_PORT` | integration | public | optional | deployment | dotenv, compose |
| `COOP_HTTP_PORT` | integration | public | optional | deployment | dotenv, compose |
| `COOP_CLIENT_HTTP_PORT` | integration | public | optional | deployment | dotenv, compose |
| `OSPREY_BIDI_STREAM_PORT` | integration | public | optional | deployment | dotenv, compose |
| `OSPREY_SYNC_ACTION_PORT` | integration | public | optional | deployment | dotenv, compose |
| `MAILPIT_TAG` | integration | public | optional | deployment | dotenv, compose |
| `MAILPIT_MAX_MESSAGES` | integration | public | optional | deployment | dotenv, compose |
| `FORMBRICKS_HTTP_PORT` | integration | public | optional | deployment | dotenv, compose |
| `FORMBRICKS_WEBAPP_URL` | integration | public | optional | deployment | dotenv, compose |
| `FORMBRICKS_DATABASE_NAME` | integration | public | optional | deployment | dotenv, compose |
| `FORMBRICKS_DATABASE_USER` | integration | public | optional | deployment | dotenv, compose |
| `FORMBRICKS_DATABASE_PASSWORD` | integration | sensitive | optional | deployment | dotenv, compose |
| `FORMBRICKS_NEXTAUTH_SECRET` | integration | sensitive | required | deployment | dotenv, compose |
| `FORMBRICKS_ENCRYPTION_KEY` | integration | sensitive | required | deployment | dotenv, compose |
| `FORMBRICKS_CRON_SECRET` | integration | sensitive | required | deployment | dotenv, compose |
| `FORMBRICKS_HUB_API_KEY` | integration | sensitive | required | deployment | dotenv, compose |
| `FORMBRICKS_CUBEJS_API_SECRET` | integration | sensitive | required | deployment | dotenv, compose |
...
| `INFISICAL_URL` | security | public | optional | process | dotenv, compose, startup |
| `INFISICAL_PROJECT_ID` | security | public | optional | process | dotenv, compose, startup |
| `INFISICAL_CLIENT_ID` | security | public | optional | process | dotenv, compose, startup |
| `INFISICAL_CLIENT_SECRET` | security | sensitive | optional | process | dotenv, compose, startup |
| `INFISICAL_ENV` | security | public | optional | process | dotenv, compose, startup |
...
| `DATABASE_TRUST_SERVER_CERTIFICATE` | database | public | defaulted | process | dotenv, compose, startup |
...
| `KEYCLOAK_API_CLIENT_SECRET` | identity | secret | required | process | dotenv, compose, startup |
| `KEYCLOAK_BLAZOR_REDIRECT_URIS` | identity | public | optional | process | dotenv, compose, startup |
| `KEYCLOAK_BLAZOR_WEB_ORIGINS` | identity | public | optional | process | dotenv, compose, startup |
| `KEYCLOAK_BLAZOR_LOGOUT_REDIRECT_URIS` | identity | public | optional | process | dotenv, compose, startup |
| `KEYCLOAK_SMTP_HOST` | identity | public | optional | process | dotenv, compose, startup |
| `KEYCLOAK_SMTP_PORT` | identity | public | optional | process | dotenv, compose, startup |
| `KEYCLOAK_SMTP_FROM` | identity | public | optional | process | dotenv, compose, startup |
| `KEYCLOAK_SMTP_FROM_DISPLAY_NAME` | identity | public | optional | process | dotenv, compose, startup |
| `KEYCLOAK_SMTP_AUTH` | identity | public | optional | process | dotenv, compose, startup |
| `KEYCLOAK_SMTP_SSL` | identity | public | optional | process | dotenv, compose, startup |
| `KEYCLOAK_SMTP_STARTTLS` | identity | public | optional | process | dotenv, compose, startup |
| `KEYCLOAK_SMTP_REPLY_TO` | identity | public | optional | process | dotenv, compose, startup |
| `KEYCLOAK_SMTP_REPLY_TO_DISPLAY_NAME` | identity | public | optional | process | dotenv, compose, startup |
| `KEYCLOAK_SMTP_ENVELOPE_FROM` | identity | public | optional | process | dotenv, compose, startup |
| `KEYCLOAK_SMTP_USER` | identity | public | optional | process | dotenv, compose, startup |
| `KEYCLOAK_SMTP_PASSWORD` | identity | sensitive | optional | process | dotenv, compose, startup |
...
| `CONTROL_PLANE_MANAGED_MODE` | deployment | public | optional | deployment | dotenv, startup |
| `CONTROL_PLANE_URL` | deployment | public | optional | deployment | dotenv, startup |
| `CONTROL_PLANE_INSTANCE_ID` | deployment | public | optional | deployment | dotenv, startup |
| `CONTROL_PLANE_REGISTRATION_TOKEN` | deployment | sensitive | optional | deployment | dotenv, startup |
| `CONTROL_PLANE_MAXIMUM_TENANT_COUNT` | deployment | public | optional | deployment | dotenv, startup |
| `CONTROL_PLANE_TENANT_ADMINISTRATOR_SIGN_IN_URL` | deployment | public | optional | deployment | dotenv, startup |
| `USE_COMMERCIAL_LUCKYPENNY` | platform | public | optional | process | dotenv, compose, startup |
| `LUCKYPENNY_LICENSE_KEY` | platform | sensitive | optional | process | dotenv, compose, startup |
| `AUTOMAPPER_COMMERCIAL_VERSION` | platform | public | optional | process | dotenv, compose, startup |
| `MEDIATR_COMMERCIAL_VERSION` | platform | public | optional | process | dotenv, compose, startup |
| `GEOCODING_PROVIDER` | integration | public | optional | capability | dotenv, compose, startup |
| `GEOCODING_ENDPOINT` | integration | public | optional | capability | dotenv, compose, startup |
| `GEOCODING_LANGUAGE` | integration | public | optional | capability | dotenv, compose, startup |
| `GEOCODING_COUNTRY_CODES` | integration | public | optional | capability | dotenv, compose, startup |
| `GEOCODING_MAXIMUM_RESULTS` | integration | public | optional | capability | dotenv, compose, startup |
| `GEOCODING_MAXIMUM_RESPONSE_BYTES` | integration | public | optional | capability | dotenv, compose, startup |
| `GEOCODING_DATASET_VERSION` | integration | public | optional | capability | dotenv, compose, startup |
| `GEOCODING_TOTAL_TIMEOUT_MILLISECONDS` | integration | public | optional | capability | dotenv, compose, startup |
| `GEOCODING_MAXIMUM_RETRY_COUNT` | integration | public | optional | capability | dotenv, compose, startup |
| `GEOCODING_RETRY_DELAYS_MILLISECONDS` | integration | public | optional | capability | dotenv, compose, startup |
| `GEOCODING_READINESS_TIMEOUT_MILLISECONDS` | integration | public | optional | capability | dotenv, compose, startup |
| `GEOCODING_SELECTION_LIFETIME_SECONDS` | integration | public | optional | capability | dotenv, compose, startup |
| `PROVISIONING_TRUSTED` | platform | public | optional | process | dotenv, startup |
| `PROVISIONING_MODE` | platform | public | optional | process | dotenv, startup |
| `MANAGED_CLIENT_EXTERNAL_PROVIDER` | platform | public | optional | process | dotenv, startup |
| `PHYSICAL_TENANCY_MODE` | platform | public | optional | process | dotenv, startup |
| `API_ENDPOINT` | platform | public | optional | process | dotenv, compose, startup |
| `CONTROL_PLANE_PUBLIC_ORIGIN` | deployment | public | optional | deployment | dotenv, compose, startup |
...
| `INSTANCE__OPERATORIDENTITY__OFFICIALORIGIN` | identity | public | optional | process | dotenv, compose, startup |
...
| `INSTANCE__OPERATORIDENTITY__REGISTRATIONIDENTIFIER` | identity | public | optional | process | dotenv, compose, startup |
...
| `PAYMENTS_STRIPE_MODE` | platform | public | optional | process | dotenv, compose, startup |
| `PAYMENTS_ORGANIZER_DIRECT_PROVIDER_CODE` | platform | public | optional | process | dotenv, compose, startup |
| `PAYMENTS_ORGANIZER_DIRECT_CONNECT_PLATFORM_ID` | platform | public | optional | process | dotenv, compose, startup |
| `PAYMENTS__CHECKOUTGOVERNANCE__COMPLAINTOWNER` | platform | public | optional | process | dotenv, compose, startup |
| `PAYMENTS__CHECKOUTGOVERNANCE__REFUNDOWNER` | platform | public | optional | process | dotenv, compose, startup |
| `PAYMENTS__CHECKOUTGOVERNANCE__DISPUTEOWNER` | platform | public | optional | process | dotenv, compose, startup |
| `PAYMENTS__CHECKOUTGOVERNANCE__RECONCILIATIONOWNER` | platform | public | optional | process | dotenv, compose, startup |
| `PAYMENTS__CHECKOUTGOVERNANCE__ACTIVATIONSTATUS` | platform | public | optional | process | dotenv, compose, startup |
| `PAYMENTS__CHECKOUTGOVERNANCE__REFUNDPOLICYLANGUAGETAG` | platform | public | optional | process | dotenv, compose, startup |
| `PAYMENTS__CHECKOUTGOVERNANCE__STATEMENTDESCRIPTOR` | platform | public | optional | process | dotenv, compose, startup |
| `PAYMENTS__CHECKOUTGOVERNANCE__CHARGETYPE` | platform | public | optional | process | dotenv, compose, startup |
| `STRIPE_PLATFORM_SECRET_KEY` | platform | secret | optional | process | dotenv, compose, startup |
| `STRIPE_WEBHOOK_SECRET` | platform | secret | optional | process | dotenv, compose, startup |
| `ADMISSIONS_CREDENTIAL_LOOKUP_HMAC_KEY` | security | secret | optional | process | dotenv, startup |
| `ADMISSIONS__CREDENTIALLOOKUP__ACTIVEKEYVERSION` | security | public | optional | process | dotenv, startup |
| `ADMISSIONS_SCANNER_CAPABILITY_HMAC_KEY` | security | secret | optional | process | dotenv, startup |
| `ADMISSIONS_RECOVERY_CAPABILITY_HMAC_KEY` | security | secret | optional | process | dotenv, startup |
| `ADMISSIONS__RECOVERY__ACTIVEKEYVERSION` | security | public | optional | process | dotenv, startup |
| `ADMISSIONS__RECOVERY__CAPABILITYLIFETIMEMINUTES` | security | public | optional | process | dotenv, startup |
| `ADMISSIONS__RECOVERY__RATELIMITBUCKETCOUNT` | security | public | optional | process | dotenv, startup |
| `ADMISSIONS__RECOVERY__RATELIMITPERMITCOUNT` | security | public | optional | process | dotenv, startup |
| `ADMISSIONS__RECOVERY__RATELIMITWINDOWSECONDS` | security | public | optional | process | dotenv, startup |
| `TICKETING__RECOVERY__ENABLED` | security | public | optional | process | dotenv, startup |
| `TICKETING__RECOVERY__EXPECTEDRELEASEREVISION` | security | public | optional | process | dotenv, startup |
| `TICKETING__RECOVERY__EXPECTEDSCHEMAREVISION` | security | public | optional | process | dotenv, startup |
| `TICKETING__RECOVERY__MINIMUMRETAINEDKEYVERSION` | security | public | optional | process | dotenv, startup |
| `TICKETING__RECOVERY__MINIMUMAUTHORITYFLOOR` | security | public | optional | process | dotenv, startup |
| `TICKETING__RECOVERY__MINIMUMPROVIDERCURSOR` | security | public | optional | process | dotenv, startup |
| `TICKETING__RECOVERY__MINIMUMIDEMPOTENCYFLOOR` | security | public | optional | process | dotenv, startup |
| `TICKETING__RECOVERY__MINIMUMWORKERFENCE` | security | public | optional | process | dotenv, startup |
| `TICKETING__RECOVERY__WARNINGOLDESTDUESECONDS` | security | public | optional | process | dotenv, startup |
| `TICKETING__RECOVERY__UNHEALTHYOLDESTDUESECONDS` | security | public | optional | process | dotenv, startup |
| `TICKETING__RECOVERY__BACKLOGTHRESHOLD` | security | public | optional | process | dotenv, startup |
| `TICKETING__RECOVERY__DECLAREDRPOMINUTES` | security | public | optional | process | dotenv, startup |
| `TICKETING__RECOVERY__DECLAREDRTOMINUTES` | security | public | optional | process | dotenv, startup |
| `TICKETING__RECOVERY__MANIFESTSIGNINGKEYREFERENCE` | security | public | optional | process | dotenv, startup |
| `TICKETING__RECOVERY__RETAINEDKEYVERSIONS__0` | security | public | optional | process | dotenv, startup |
| `TICKETING_RECOVERY_MANIFEST_HMAC_KEY` | security | secret | required | process | dotenv, startup |
| `AUTHORIZATION_PROVIDER` | platform | public | optional | process | dotenv, compose, startup |
| `CERBOS_GRPC_ENDPOINT` | integration | secret | optional | capability | dotenv, compose, startup |
| `CERBOS_HTTP_ENDPOINT` | integration | public | optional | capability | dotenv, compose, startup |
| `CERBOS_USE_TLS` | integration | public | optional | capability | dotenv, compose, startup |
| `CERBOS_PLAINTEXT_MODE` | integration | public | optional | capability | dotenv, compose, startup |
| `CERBOS_ADMIN_USERNAME` | integration | secret | optional | capability | dotenv, compose, startup |
| `CERBOS_ADMIN_PASSWORD_HASH` | integration | sensitive | optional | capability | dotenv, compose, startup |
| `CERBOS_ADMIN_PASSWORD` | integration | secret | optional | capability | dotenv, compose, startup |
| `CERBOS_PG_URL` | integration | public | optional | capability | dotenv, compose, startup |
| `CERBOS_POSTGRES_USER` | integration | public | optional | deployment | dotenv, compose |
| `CERBOS_POSTGRES_PASSWORD` | integration | sensitive | optional | deployment | dotenv, compose |
| `CERBOS_POSTGRES_DB` | integration | public | optional | deployment | dotenv, compose |
| `STORAGE_S3_ENDPOINT` | storage | secret | optional | capability | dotenv, compose, startup |
| `STORAGE_S3_PUBLIC_ENDPOINT` | storage | secret | optional | capability | dotenv, compose, startup |
| `STORAGE_S3_REGION` | storage | secret | optional | capability | dotenv, compose, startup |
| `STORAGE_S3_BUCKET_NAME` | storage | secret | optional | capability | dotenv, compose, startup |
| `STORAGE_S3_ACCESS_KEY_ID` | storage | secret | optional | capability | dotenv, compose, startup |
| `STORAGE_S3_SECRET_ACCESS_KEY` | storage | secret | optional | capability | dotenv, compose, startup |
| `LOCAL_STORAGE_ROOT_PATH` | storage | public | optional | capability | dotenv, compose, startup |
| `LOCAL_STORAGE_CREATE_ROOT_IF_MISSING` | storage | public | optional | capability | dotenv, compose, startup |
| `STORAGE_RECONCILIATION_ENABLED` | storage | public | defaulted | capability | dotenv, compose, startup |
| `STORAGE_RECONCILIATION_DRY_RUN` | storage | public | defaulted | capability | dotenv, compose, startup |
| `STORAGE_RECONCILIATION_QUARANTINE_MISSING_OBJECTS` | storage | public | optional | capability | dotenv, compose, startup |
| `STORAGE_RECONCILIATION_QUARANTINE_ORPHAN_LOCAL_FILES` | storage | public | optional | capability | dotenv, compose, startup |
| `STORAGE_RECONCILIATION_DELETE_QUARANTINED_OBJECTS` | storage | public | optional | capability | dotenv, compose, startup |
| `AI_PROVIDER` | integration | public | optional | capability | dotenv, compose, startup |
| `AI_ENDPOINT` | integration | public | optional | capability | dotenv, compose, startup |
| `AI_MODEL_ID` | integration | public | optional | capability | dotenv, compose, startup |
| `AI_API_KEY` | integration | sensitive | optional | capability | dotenv, compose, startup |
| `AI_TOOL_PROPOSALS_ENABLED` | integration | public | defaulted | capability | dotenv, compose, startup |
| `MCP_ENABLED` | platform | public | defaulted | process | dotenv, compose, startup |
| `MCP_ENDPOINT_PATH` | platform | public | optional | process | dotenv, compose, startup |
| `MCP_STATELESS` | platform | public | optional | process | dotenv, compose, startup |
| `MCP_ENABLE_LEGACY_SSE` | platform | public | optional | process | dotenv, compose, startup |
...
| `WEB_PUSH_ENABLED` | messaging | public | defaulted | capability | dotenv, compose, startup |
| `VAPID_SUBJECT` | messaging | public | optional | capability | dotenv, compose, startup |
| `VAPID_PUBLIC_KEY` | messaging | public | optional | capability | dotenv, compose, startup |
| `VAPID_PRIVATE_KEY` | messaging | sensitive | optional | capability | dotenv, compose, startup |
| `MESSAGING_URI` | messaging | public | optional | capability | dotenv, compose, startup |
| `EMAIL_DISPATCH_RABBITMQ_ENABLED` | messaging | public | optional | capability | dotenv, compose, startup |
| `EMAIL_DISPATCH_RABBITMQ_CONNECTION_STRING_NAME` | messaging | sensitive | optional | capability | dotenv, compose, startup |
| `EMAIL_DISPATCH_RABBITMQ_CONNECTION_STRING` | messaging | sensitive | optional | capability | dotenv, compose, startup |
| `EMAIL_DISPATCH_RABBITMQ_EXCHANGE_NAME` | messaging | public | optional | capability | dotenv, compose, startup |
| `EMAIL_DISPATCH_RABBITMQ_DISPATCH_QUEUE_NAME` | messaging | public | optional | capability | dotenv, compose, startup |
| `EMAIL_DISPATCH_RABBITMQ_DISPATCH_ROUTING_KEY` | messaging | public | optional | capability | dotenv, compose, startup |
| `EMAIL_DISPATCH_RABBITMQ_DEAD_LETTER_EXCHANGE_NAME` | messaging | public | optional | capability | dotenv, compose, startup |
| `EMAIL_DISPATCH_RABBITMQ_DEAD_LETTER_QUEUE_NAME` | messaging | public | optional | capability | dotenv, compose, startup |
| `EMAIL_DISPATCH_RABBITMQ_DEAD_LETTER_ROUTING_KEY` | messaging | public | optional | capability | dotenv, compose, startup |
| `EMAIL_DISPATCH_RABBITMQ_PARKING_QUEUE_NAME` | messaging | public | optional | capability | dotenv, compose, startup |
| `EMAIL_DISPATCH_RABBITMQ_PARKING_ROUTING_KEY` | messaging | public | optional | capability | dotenv, compose, startup |
| `EMAIL_DISPATCH_RABBITMQ_CLIENT_PROVIDED_NAME` | messaging | public | optional | capability | dotenv, compose, startup |
| `EMAIL_DISPATCH_RABBITMQ_CONSUMER_ID` | messaging | public | optional | capability | dotenv, compose, startup |
| `EMAIL_DISPATCH_RABBITMQ_PREFETCH_COUNT` | messaging | public | optional | capability | dotenv, compose, startup |
| `EMAIL_DISPATCH_RABBITMQ_DEAD_LETTER_REPLAY_ENABLED` | messaging | public | optional | capability | dotenv, compose, startup |
| `EMAIL_DISPATCH_RABBITMQ_DEAD_LETTER_REPLAY_CONSUMER_ID` | messaging | public | optional | capability | dotenv, compose, startup |
| `EMAIL_DISPATCH_RABBITMQ_DEAD_LETTER_REPLAY_PREFETCH_COUNT` | messaging | public | optional | capability | dotenv, compose, startup |
| `EMAIL_DISPATCH_RABBITMQ_PUBLISH_TIMEOUT_SECONDS` | messaging | public | optional | capability | dotenv, compose, startup |
| `EMAIL_DISPATCH_RABBITMQ_PUBLISHER_POLLING_INTERVAL_SECONDS` | messaging | public | optional | capability | dotenv, compose, startup |
| `EMAIL_DISPATCH_RABBITMQ_PUBLISHER_BATCH_SIZE` | messaging | public | optional | capability | dotenv, compose, startup |
| `EMAIL_DISPATCH_RABBITMQ_PUBLISHER_RETRY_DELAY_SECONDS` | messaging | public | optional | capability | dotenv, compose, startup |
| `WEBHOOKS_ENABLED` | integration | public | defaulted | capability | dotenv, compose, startup |
| `WEBHOOKS_PROVIDER` | integration | public | optional | capability | dotenv, compose, startup |
| `WEBHOOKS_SVIX_BASE_URL` | integration | public | optional | capability | dotenv, compose, startup |
| `WEBHOOKS_SVIX_ENVIRONMENT` | integration | public | optional | capability | dotenv, compose, startup |
| `WEBHOOKS_SVIX_PROVIDER_VERSION` | integration | public | optional | capability | dotenv, compose, startup |
| `WEBHOOKS_SVIX_CAPABILITY_POLICY_VERSION` | integration | public | optional | capability | dotenv, compose, startup |
| `WEBHOOKS_SVIX_AUTH_TOKEN_SECRET_REF` | integration | sensitive | optional | capability | dotenv, compose, startup |
| `WEBHOOKS_SVIX_OPERATIONAL_WEBHOOK_SECRET_REF` | integration | sensitive | optional | capability | dotenv, compose, startup |
| `WEBHOOKS_SVIX_AUTH_TOKEN` | integration | secret | optional | capability | dotenv, compose, startup |
| `WEBHOOKS_SVIX_OPERATIONAL_WEBHOOK_SECRET` | integration | secret | optional | capability | dotenv, compose, startup |
| `SVIX_TAG` | integration | public | optional | deployment | dotenv, compose |
| `SVIX_DB_DATABASE` | integration | public | optional | deployment | dotenv, compose |
| `SVIX_DB_USERNAME` | integration | public | optional | deployment | dotenv, compose |
| `SVIX_DB_PASSWORD` | integration | sensitive | optional | deployment | dotenv, compose |
| `SVIX_DB_DSN` | integration | public | optional | deployment | dotenv, compose |
| `SVIX_REDIS_DSN` | integration | public | optional | deployment | dotenv, compose |
| `SVIX_QUEUE_TYPE` | integration | public | optional | deployment | dotenv, compose |
| `SVIX_CACHE_TYPE` | integration | public | optional | deployment | dotenv, compose |
| `SVIX_JWT_SECRET` | integration | sensitive | optional | deployment | dotenv, compose |
| `WEBLATE_IMAGE` | integration | public | optional | deployment | dotenv, compose |
| `WEBLATE_SITE_DOMAIN` | integration | public | optional | deployment | dotenv, compose |
| `WEBLATE_ADMIN_NAME` | integration | public | optional | deployment | dotenv, compose |
| `WEBLATE_ADMIN_EMAIL` | integration | sensitive | optional | deployment | dotenv, compose |
| `WEBLATE_ADMIN_PASSWORD` | integration | sensitive | optional | deployment | dotenv, compose |
| `WEBLATE_POSTGRES_USER` | integration | public | optional | deployment | dotenv, compose |
| `WEBLATE_POSTGRES_PASSWORD` | integration | sensitive | optional | deployment | dotenv, compose |
| `WEBLATE_POSTGRES_DB` | integration | public | optional | deployment | dotenv, compose |
| `REPORTING_ENABLED` | observability | public | defaulted | none | dotenv, compose, startup |
| `REPORTING_MODE` | observability | public | optional | none | dotenv, compose, startup |
| `REPORTING_SYNC_REPORTS` | observability | public | optional | none | dotenv, compose, startup |
| `REPORTING_EVALUATE_SIGNALS` | observability | public | optional | none | dotenv, compose, startup |
| `REPORTING_MIRROR_REVIEW_QUEUE` | observability | public | optional | none | dotenv, compose, startup |
| `REPORTING_EXECUTE_DECISIONS` | observability | public | optional | none | dotenv, compose, startup |
| `REPORTING_HEALTH_STUCK_PROVIDER_SYNC_MINUTES` | observability | public | optional | none | dotenv, startup |
| `REPORTING_HEALTH_FAILED_PROVIDER_SYNC_WARNING_THRESHOLD` | observability | public | optional | none | dotenv, startup |
| `REPORTING_OSPREY_ENABLED` | observability | public | optional | none | dotenv, compose, startup |
| `REPORTING_OSPREY_ENDPOINT_URL` | observability | public | optional | none | dotenv, compose, startup |
| `REPORTING_OSPREY_API_KEY` | observability | sensitive | optional | none | dotenv, compose, startup |
| `REPORTING_OSPREY_ALLOW_LOCAL_PROVIDER_ENDPOINTS` | observability | public | optional | none | dotenv, compose, startup |
| `REPORTING_COOP_ENABLED` | observability | public | optional | none | dotenv, compose, startup |
| `REPORTING_COOP_ENDPOINT_URL` | observability | public | optional | none | dotenv, compose, startup |
| `REPORTING_COOP_API_KEY` | observability | sensitive | optional | none | dotenv, compose, startup |
| `REPORTING_COOP_ALLOW_LOCAL_PROVIDER_ENDPOINTS` | observability | public | optional | none | dotenv, compose, startup |
| `REPORTING_COOP_WEBHOOK_SECRET` | observability | sensitive | optional | none | dotenv, compose, startup |
| `COOP_IMAGE` | integration | public | optional | deployment | dotenv, compose |
| `COOP_MIGRATIONS_IMAGE` | integration | public | optional | deployment | dotenv, compose |
| `COOP_CLIENT_IMAGE` | integration | public | optional | deployment | dotenv, compose |
| `COOP_NODE_ENV` | integration | public | optional | deployment | dotenv, compose |
| `COOP_OTEL_SERVICE_NAME` | integration | public | optional | deployment | dotenv, compose |
| `COOP_UI_URL` | integration | public | optional | deployment | dotenv, compose |
| `COOP_SESSION_SECRET` | integration | sensitive | optional | deployment | dotenv, compose |
| `COOP_DATABASE_USER` | integration | public | optional | deployment | dotenv, compose |
| `COOP_DATABASE_PASSWORD` | integration | sensitive | optional | deployment | dotenv, compose |
| `COOP_DATABASE_NAME` | integration | public | optional | deployment | dotenv, compose |
| `COOP_WAREHOUSE_ADAPTER` | integration | public | optional | deployment | dotenv, compose |
| `COOP_ANALYTICS_ADAPTER` | integration | public | optional | deployment | dotenv, compose |
| `COOP_SCYLLA_HOSTS` | integration | public | optional | deployment | dotenv, compose |
| `COOP_SCYLLA_USERNAME` | integration | public | optional | deployment | dotenv, compose |
| `COOP_SCYLLA_PASSWORD` | integration | sensitive | optional | deployment | dotenv, compose |
| `COOP_SCYLLA_LOCAL_DATACENTER` | integration | public | optional | deployment | dotenv, compose |
| `COOP_SCYLLA_SSL` | integration | public | optional | deployment | dotenv, compose |
| `OSPREY_IMAGE` | integration | public | optional | deployment | dotenv, compose |
| `OSPREY_RUST_LOG` | integration | public | optional | deployment | dotenv, compose |
| `OSPREY_POD_IP` | integration | public | optional | deployment | dotenv, compose |
| `LISTMONK_ENABLED` | integration | public | defaulted | capability | dotenv, compose, startup |
| `LISTMONK_INSTANCE_URL` | integration | public | optional | capability | dotenv, compose, startup |
| `LISTMONK_DEFAULT_LIST_ID` | integration | public | optional | capability | dotenv, compose, startup |
| `LISTMONK_PRECONFIRM_SUBSCRIPTIONS` | integration | public | optional | capability | dotenv, compose, startup |
| `LISTMONK_SYNC_ON_REGISTRATION` | integration | public | optional | capability | dotenv, compose, startup |
| `LISTMONK_API_USERNAME` | integration | secret | optional | capability | dotenv, compose, startup |
| `LISTMONK_API_KEY` | integration | secret | optional | capability | dotenv, compose, startup |
...
| `ERASURE_WRITER_REPLICA_COUNT` | platform | public | optional | process | dotenv, compose, startup |
| `ERASURE_BUSY_TIMEOUT_SECONDS` | platform | public | optional | process | dotenv, compose, startup |
| `DATABASE_ERASURE_HOST` | database | public | optional | process | dotenv, compose, startup |
| `DATABASE_ERASURE_PORT` | database | public | optional | process | dotenv, compose, startup |
| `DATABASE_ERASURE_NAME` | database | public | optional | process | dotenv, compose, startup |
| `DATABASE_ERASURE_RUNTIME_USERNAME` | database | public | optional | process | dotenv, compose, startup |
| `DATABASE_ERASURE_RUNTIME_PASSWORD` | database | sensitive | optional | process | dotenv, compose, startup |
| `DATABASE_ERASURE_MIGRATOR_USERNAME` | database | public | optional | process | dotenv, compose, startup |
| `DATABASE_ERASURE_MIGRATOR_PASSWORD` | database | sensitive | optional | process | dotenv, compose, startup |
| `DATABASE_ERASURE_TLS_MODE` | database | public | optional | process | dotenv, compose, startup |
| `DATABASE_ERASURE_TRUST_SERVER_CERTIFICATE` | database | public | optional | process | dotenv, compose, startup |
...
### Promotion Code Lookup Configuration

Promotion-code lookup has one non-secret static option and one separately bound secret family:

| Key | Default | Description |
|---|---:|---|
| `Promotions:CodeLookup:ActiveKeyVersion` | `1` | Positive HMAC-key version used for newly published or rotated codes. Environment-variable form: `Promotions__CodeLookup__ActiveKeyVersion`. Startup validation rejects values below `1`. |

The HMAC material is not stored under this configuration section. It resolves through the instance-only secret definition `promotions.code_lookup_hmac_key` with qualifier `v{ActiveKeyVersion}`; for version `1`, the exact qualifier is `v1`. The default initial source coordinates are Infisical `/promotions/PROMOTIONS_CODE_LOOKUP_HMAC_KEY` or environment variable `PROMOTIONS_CODE_LOOKUP_HMAC_KEY`, but either source still requires the matching qualified `SecretBinding`. During overlap, each retained qualifier must reference its own immutable external value, for example version-specific Infisical keys or environment-variable names.

Changing `ActiveKeyVersion` changes only new code writes. Lookup reads inspect the key versions referenced by active code rows and resolve each matching qualifier, so operators must retain older qualified secrets until no active promotion code uses them. See [SECRETS.md](SECRETS.md#promotion-code-lookup-hmac-key) for value format and the rotation sequence.
