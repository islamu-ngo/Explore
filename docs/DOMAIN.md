...
Checkout, capture, refunds, disputes, admission, QR/check-in, transfers, payouts, and legal/tax/invoice support are not implemented domain behavior. `ProtectedDelayedPayout` remains approval-gated and absent from the default profile.
