...
Use this workflow when a task asks for a new `.claude/skills/<name>/SKILL.md` or a significant resource-library update.

## Sequence

1. Classify the task as `create-agent-context-skill` when the work changes `.claude/skills/**`, skill resources, skill schema tests, or skill-related intent routing.
2. Read `AGENTS.md`, `docs/QUICK_REFERENCE.md`, `docs/DOCUMENTATION_STYLE_GUIDE.md`, `docs/OPERATIONS.md`, `docs/TESTING.md`, `.claude/skills/_SKILL_SCHEMA.md`, and any active `dev/active/*` plan/context/tasks for the skill.
