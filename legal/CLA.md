...
Signature records may be retained for as long as needed to document the licensing status of Contributions and may be stored in the project repository or a dedicated signature repository. If the configured signatures file is public, these records may be publicly visible.
