...
public class ExternalApiKeyQuotaRepository : GenericRepository<ExternalApiKeyQuota, Guid>, IExternalApiKeyQuotaRepository
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await _dbContext.Database.ExecuteSqlInterpolatedAsync(
            $@"INSERT INTO ""ExternalApiKeyQuotas"" (""Id"", ""ExternalApiKeyId"", ""PeriodStart"", ""PeriodEnd"", ""CreditLimit"", ""CreditsUsed"", ""RolloverCredits"", ""CreatedAt"")
               VALUES ({newId}, {externalApiKeyId}, {periodStart}, {periodEnd}, {creditLimit}, {0}, {rolloverCredits}, {now})
    ...
    {
        // Atomic conditional UPDATE — race-safe credit enforcement
