...
{
    /// <inheritdoc />
    public partial class groupactor : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Actor_UserOrOrganization", "(user_id IS NOT NULL AND organization_id IS NULL) OR (user_id IS NULL AND organization_id IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.AddForeignKey(
                name: "fk_actors_groups_group_id1",
                table: "actors",
                column: "group_id1",
                principalTable: "groups",
                principalColumn: "id");
