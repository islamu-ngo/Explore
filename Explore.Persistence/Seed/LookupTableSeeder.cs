...
public static class LookupTableSeeder
{
    ...
    private static async Task SeedSystemSettingsAsync(ExploreDbContext context, CancellationToken ct)
    {
        ...
        var expectedSettings = new[]
        {
            ...
            new SystemSetting { Id = SeedIds.SystemSettingEmailSmtpHostId, SettingKey = GovernanceSettingKeys.EmailSmtpHost, Value = "\"\"", ValueType = SettingValueType.String, IsLocked = false, Description = "SMTP server hostname (e.g., smtp.gmail.com, smtp.mailgun.org)", Category = "Email", DisplayOrder = 1, CreatedAt = seedTimestamp },
            new SystemSetting { Id = SeedIds.SystemSettingEmailSmtpPortId, SettingKey = GovernanceSettingKeys.EmailSmtpPort, Value = "587", ValueType = SettingValueType.Integer, IsLocked = false, Description = "SMTP server port (587 for StartTLS, 465 for SSL, 25 for unencrypted)", Category = "Email", DisplayOrder = 2, CreatedAt = seedTimestamp },
            new SystemSetting { Id = SeedIds.SystemSettingEmailSmtpUsernameId, SettingKey = GovernanceSettingKeys.EmailSmtpUsername, Value = "\"\"", ValueType = SettingValueType.String, IsLocked = false, Description = "SMTP authentication username", Category = "Email", DisplayOrder = 3, CreatedAt = seedTimestamp },
            new SystemSetting { Id = SeedIds.SystemSettingEmailSmtpPasswordId, SettingKey = GovernanceSettingKeys.EmailSmtpPassword, Value = "\"\"", ValueType = SettingValueType.String, IsLocked = false, Description = "SMTP authentication password (stored encrypted)", Category = "Email", DisplayOrder = 4, CreatedAt = seedTimestamp },
            new SystemSetting { Id = SeedIds.SystemSettingEmailSmtpSecurityId, SettingKey = GovernanceSettingKeys.EmailSmtpSecurity, Value = "\"StartTls\"", ValueType = SettingValueType.String, IsLocked = false, AllowedValues = "[\"None\", \"StartTls\", \"SslOnConnect\", \"Auto\"]", Description = "SMTP connection security mode", Category = "Email", DisplayOrder = 5, CreatedAt = seedTimestamp },
            new SystemSetting { Id = SeedIds.SystemSettingEmailFromAddressId, SettingKey = GovernanceSettingKeys.EmailFromAddress, Value = "\"\"", ValueType = SettingValueType.String, IsLocked = false, Description = "Default sender email address for outbound emails", Category = "Email", DisplayOrder = 6, CreatedAt = seedTimestamp },
            new SystemSetting { Id = SeedIds.SystemSettingEmailFromNameId, SettingKey = GovernanceSettingKeys.EmailFromName, Value = "\"Explore\"", ValueType = SettingValueType.String, IsLocked = false, Description = "Default sender display name for outbound emails", Category = "Email", DisplayOrder = 7, CreatedAt = seedTimestamp },
            new SystemSetting { Id = SeedIds.SystemSettingEmailSmtpTimeoutId, SettingKey = GovernanceSettingKeys.EmailSmtpTimeoutSeconds, Value = "30", ValueType = SettingValueType.Integer, IsLocked = false, Description = "SMTP connection timeout in seconds", Category = "Email", DisplayOrder = 8, CreatedAt = seedTimestamp },
            new SystemSetting { Id = SeedIds.SystemSettingEmailSmtpSkipCertValidationId, SettingKey = GovernanceSettingKeys.EmailSmtpSkipCertValidation, Value = "false", ValueType = SettingValueType.Boolean, IsLocked = false, Description = "Skip TLS certificate validation (development/self-signed certs only)", Category = "Email", DisplayOrder = 9, CreatedAt = seedTimestamp },

            // Object Storage / S3
            new SystemSetting { Id = SeedIds.SystemSettingS3EndpointId, SettingKey = GovernanceSettingKeys.S3Endpoint, Value = "\"\"", ValueType = SettingValueType.String, IsLocked = false, Description = "S3-compatible endpoint URL (e.g., https://fsn1.your-objectstorage.com)", Category = "ObjectStorage", DisplayOrder = 1, CreatedAt = seedTimestamp },
            new SystemSetting { Id = SeedIds.SystemSettingS3PublicEndpointId, SettingKey = GovernanceSettingKeys.S3PublicEndpoint, Value = "\"\"", ValueType = SettingValueType.String, IsLocked = false, Description = "Public endpoint for presigned URLs (if different from internal endpoint)", Category = "ObjectStorage", DisplayOrder = 2, CreatedAt = seedTimestamp },
            new SystemSetting { Id = SeedIds.SystemSettingS3BucketNameId, SettingKey = GovernanceSettingKeys.S3BucketName, Value = "\"\"", ValueType = SettingValueType.String, IsLocked = false, Description = "S3 bucket name for object storage", Category = "ObjectStorage", DisplayOrder = 3, CreatedAt = seedTimestamp },
            new SystemSetting { Id = SeedIds.SystemSettingS3AccessKeyIdId, SettingKey = GovernanceSettingKeys.S3AccessKeyId, Value = "\"\"", ValueType = SettingValueType.String, IsLocked = false, Description = "S3 access key ID for authentication", Category = "ObjectStorage", DisplayOrder = 4, CreatedAt = seedTimestamp },
