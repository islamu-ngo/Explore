...
public static class HateoasAssemblerRegistration
{
    ...
    public static IServiceCollection AddHateoasAssemblers(this IServiceCollection services)
    {
        ...
        services.AddScoped<ILinkPolicy<PaidEventPublicationPreflightDto>, PaidEventPublicationPreflightLinkPolicy>();
        services.AddScoped<ICollectionLinkPolicy<PaidEventPublicationPreflightDto>, PaidEventPublicationPreflightCollectionLinkPolicy>();
        services.AddScoped<IResourceAssembler<PaidEventPublicationPreflightDto, PaidEventPublicationPreflightDto>, PaidEventPublicationPreflightResourceAssembler>();
        ...
        services.AddScoped<ILinkPolicy<PaidEventPolicyDto>, InstancePaidEventPolicyLinkPolicy>();
        services.AddScoped<ICollectionLinkPolicy<PaidEventPolicyDto>, InstancePaidEventPolicyCollectionLinkPolicy>();
        services.AddScoped<IResourceAssembler<PaidEventPolicyDto, PaidEventPolicyDto>, InstancePaidEventPolicyResourceAssembler>();
        services.AddScoped<ILinkPolicy<TenantPaidEventPolicyConfigurationDto>, TenantPaidEventPolicyConfigurationLinkPolicy>();
        services.AddScoped<ICollectionLinkPolicy<TenantPaidEventPolicyConfigurationDto>, TenantPaidEventPolicyConfigurationCollectionLinkPolicy>();
        services.AddScoped<IResourceAssembler<TenantPaidEventPolicyConfigurationDto, TenantPaidEventPolicyConfigurationDto>, TenantPaidEventPolicyConfigurationResourceAssembler>();
