    ...
    public partial class CompletePaidCheckoutSafetyActivation : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropIndex(
                name: "ix_payment_reconciliation_effects_status_next_attempt_at_creat",
                schema: "islamu_event",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    paid_event_policy_version_id = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    status_code = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: false),
                    request_reason_code = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    requested_by_user_id = table.Column<Guid>(type: "uuid", nullable: false),
                    requested_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    reviewed_by_user_id = table.Column<Guid>(type: "uuid", nullable: true),
                    review_reason_code = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    scope_key = table.Column<string>(type: "character varying(48)", maxLength: 48, nullable: false),
                    is_stopped = table.Column<bool>(type: "boolean", nullable: false),
                    resume_requested_by = table.Column<Guid>(type: "uuid", nullable: true),
                    resume_requested_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    resume_reviewed_by = table.Column<Guid>(type: "uuid", nullable: true),
                    resume_reviewed_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    event_id = table.Column<Guid>(type: "uuid", nullable: false),
                    composition_revision = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    disclosure_revision = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    merchant_disclosure_text = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false),
                    operator_id = table.Column<Guid>(type: "uuid", nullable: false),
                    operator_display_name = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    is_official_instance = table.Column<bool>(type: "boolean", nullable: false),
                    official_origin = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    operator_region_code = table.Column<string>(type: "character varying(8)", maxLength: 8, nullable: false),
                    operator_website_url = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    operator_legal_notice_url = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    operator_terms_url = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    operator_privacy_url = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    complaint_contact = table.Column<string>(type: "character varying(320)", maxLength: 320, nullable: false),
                    complaint_owner = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    refund_owner = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    dispute_owner = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    reconciliation_owner = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    activation_status = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
                    delivery_starts_at_utc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    delivery_ends_at_utc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    event_time_zone_id = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    currency_code = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: false),
                    ...
                    tenant_policy_version_id = table.Column<Guid>(type: "uuid", nullable: true),
                    ...
                    support_contact = table.Column<string>(type: "character varying(320)", maxLength: 320, nullable: false),
                    provider_code = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    provider_profile_code = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    charge_type = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    statement_descriptor = table.Column<string>(type: "character varying(22)", maxLength: 22, nullable: false),
                    provider_environment = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: false),
                    provider_credential_owner = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_paid_order_acceptance_snapshots_registration_orders_tenant_",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    tenant_id = table.Column<Guid>(type: "uuid", nullable: false),
                    paid_checkout_sale_control_id = table.Column<Guid>(type: "uuid", nullable: false),
                    sequence = table.Column<int>(type: "integer", nullable: false),
                    event_id = table.Column<Guid>(type: "uuid", nullable: true),
                    action_code = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_paid_checkout_sale_control_audits_paid_checkout_sale_contro",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_paid_order_acceptance_lines_paid_order_acceptance_snapshots",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_paid_checkout_review_approvals_tenant_id_event_id_organizer",
                schema: "islamu_event",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_paid_checkout_sale_control_audits_tenant_id_event_id_occurr",
                schema: "islamu_event",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_paid_order_acceptance_lines_tenant_id_paid_order_acceptance",
                schema: "islamu_event",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_paid_order_acceptance_snapshots_tenant_id_event_id_accepted",
                schema: "islamu_event",
                table: "paid_order_acceptance_snapshots",
                columns: new[] { "tenant_id", "event_id", "accepted_at" });

            migrationBuilder.CreateIndex(
                name: "ix_paid_order_acceptance_snapshots_tenant_id_registration_orde",
                schema: "islamu_event",
                table: "paid_order_acceptance_snapshots",
            ...
            migrationBuilder.AddForeignKey(
                name: "fk_payment_attempts_paid_order_acceptance_snapshots_tenant_id_",
                schema: "islamu_event",
                table: "payment_attempts",
                columns: new[] { "tenant_id", "paid_order_acceptance_snapshot_id" },
                principalSchema: "islamu_event",
