    ...
    public partial class AddExternalImportedRegistrationFormVersions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropForeignKey(
                name: "fk_registration_provider_schema_revisions_registration_provide",
                schema: "islamu_event",
                table: "registration_provider_schema_revisions");

            migrationBuilder.DropForeignKey(
                name: "fk_registration_provider_schema_revisions_registration_provide1",
                schema: "islamu_event",
                table: "registration_provider_schema_revisions");

            migrationBuilder.DropIndex(
                name: "ix_registration_provider_schema_revisions_tenant_id_registrati",
                schema: "islamu_event",
                table: "registration_provider_schema_revisions");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_registration_provider_connections_tenant_id_provider_code_p",
                schema: "islamu_event",
                table: "registration_provider_connections",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_registration_form_versions_external_registration_provider_c",
                schema: "islamu_event",
                table: "registration_form_versions",
                column: "external_registration_provider_connection_id");

            migrationBuilder.CreateIndex(
                name: "ix_registration_form_versions_external_registration_provider_s",
                schema: "islamu_event",
                table: "registration_form_versions",
            ...
            migrationBuilder.AddForeignKey(
                name: "fk_registration_form_versions_registration_form_version_source",
                schema: "islamu_event",
                table: "registration_form_versions",
                column: "source_kind_id",
            ...
            migrationBuilder.AddForeignKey(
                name: "fk_registration_form_versions_registration_provider_connection",
                schema: "islamu_event",
                table: "registration_form_versions",
                column: "external_registration_provider_connection_id",
                principalSchema: "islamu_event",
            ...
            migrationBuilder.AddForeignKey(
                name: "fk_registration_form_versions_registration_provider_schema_rev",
                schema: "islamu_event",
                table: "registration_form_versions",
                column: "external_registration_provider_schema_revision_id",
                principalSchema: "islamu_event",
            ...
            migrationBuilder.AddForeignKey(
                ...
                principalSchema: "islamu_event",
                principalTable: "registration_provider_schema_authorities",
                principalColumn: "id",
                onDelete: ReferentialAction.Restrict);

            migrationBuilder.AddForeignKey(
                name: "fk_registration_provider_schema_revisions_registration_provide2",
                schema: "islamu_event",
                table: "registration_provider_schema_revisions",
                columns: new[] { "tenant_id", "registration_provider_connection_id" },
                principalSchema: "islamu_event",
                principalTable: "registration_provider_connections",
