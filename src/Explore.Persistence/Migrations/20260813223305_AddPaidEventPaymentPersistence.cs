        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    active_uniqueness_slot = table.Column<string>(type: "character varying(48)", maxLength: 48, nullable: false),
                    status_id = table.Column<int>(type: "integer", nullable: false),
                    merchant_country_code = table.Column<string>(type: "character varying(2)", maxLength: 2, nullable: true),
                    ...
                    last_readiness_observed_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    last_readiness_evidence_revision = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: true),
                    replaces_connection_id = table.Column<Guid>(type: "uuid", nullable: true),
                    replaced_by_connection_id = table.Column<Guid>(type: "uuid", nullable: true),
                    replaced_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    disabled_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    disabled_reason_code = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_organizer_payment_provider_connections_actors_organizer_act",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    policy_scope_key = table.Column<string>(type: "character varying(48)", maxLength: 48, nullable: false),
                    version_number = table.Column<int>(type: "integer", nullable: false),
                    is_active = table.Column<bool>(type: "boolean", nullable: false),
                    active_uniqueness_slot = table.Column<int>(type: "integer", nullable: false),
                    is_payments_enabled = table.Column<bool>(type: "boolean", nullable: false),
                    requires_local_verification = table.Column<bool>(type: "boolean", nullable: false),
                    default_currency_code = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: true),
                    requires_first_paid_event_review = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    tenant_id = table.Column<Guid>(type: "uuid", nullable: false),
                    organizer_payment_provider_connection_id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_organizer_payment_provider_connection_supported_currencies_",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_paid_event_policy_allowed_currencies_paid_event_policy_vers",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_paid_event_policy_allowed_organizer_kinds_paid_event_policy",
                        columns: x => new { x.policy_scope_key, x.paid_event_policy_version_id },
                        principalSchema: "islamu_event",
                        principalTable: "paid_event_policy_versions",
                        principalColumns: new[] { "policy_scope_key", "id" },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_paid_event_policy_currency_risk_limits_paid_event_policy_ve",
                        columns: x => new { x.policy_scope_key, x.paid_event_policy_version_id },
                        principalSchema: "islamu_event",
                        principalTable: "paid_event_policy_versions",
                        principalColumns: new[] { "policy_scope_key", "id" },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_paid_event_policy_refund_protections_paid_event_policy_vers",
                        columns: x => new { x.policy_scope_key, x.paid_event_policy_version_id },
                        principalSchema: "islamu_event",
                        principalTable: "paid_event_policy_versions",
                        principalColumns: new[] { "policy_scope_key", "id" },
            ...
            migrationBuilder.CreateIndex(
                name: "ix_organizer_payment_provider_connection_supported_currencies_",
                schema: "islamu_event",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_organizer_payment_provider_connections_active_scope_key_act",
                schema: "islamu_event",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_organizer_payment_provider_connections_provider_code_connec",
                schema: "islamu_event",
                table: "organizer_payment_provider_connections",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_organizer_payment_provider_connections_tenant_id_organizer_",
                schema: "islamu_event",
                table: "organizer_payment_provider_connections",
                columns: new[] { "tenant_id", "organizer_actor_id", "provider_code", "connect_platform_id", "status_id" });

            migrationBuilder.CreateIndex(
                name: "ix_organizer_payment_provider_connections_tenant_id_replaced_b",
                schema: "islamu_event",
                table: "organizer_payment_provider_connections",
                columns: new[] { "tenant_id", "replaced_by_connection_id" });

            migrationBuilder.CreateIndex(
                name: "ix_organizer_payment_provider_connections_tenant_id_replaces_c",
                schema: "islamu_event",
                table: "organizer_payment_provider_connections",
                columns: new[] { "tenant_id", "replaces_connection_id" });

            migrationBuilder.CreateIndex(
                name: "ix_paid_event_policy_allowed_currencies_policy_scope_key_paid_",
                schema: "islamu_event",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_paid_event_policy_allowed_organizer_kinds_policy_scope_key_",
                schema: "islamu_event",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_paid_event_policy_currency_risk_limits_policy_scope_key_pai",
                schema: "islamu_event",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_paid_event_policy_refund_protections_policy_scope_key_paid_",
                schema: "islamu_event",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_paid_event_policy_versions_policy_scope_key_active_uniquene",
                schema: "islamu_event",
