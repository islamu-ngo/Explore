        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    recipient_tenant_id = table.Column<Guid>(type: "uuid", nullable: false),
                    recipient_organizer_actor_id = table.Column<Guid>(type: "uuid", nullable: false),
                    recipient_connection_id = table.Column<Guid>(type: "uuid", nullable: false),
                    recipient_provider_code = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    recipient_connect_platform_id = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: false),
                    recipient_external_account_id = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    recipient_merchant_country_code = table.Column<string>(type: "character varying(2)", maxLength: 2, nullable: false),
                    recipient_currency_code = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: false),
                    recipient_profile_code = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    recipient_instance_policy_version_id = table.Column<Guid>(type: "uuid", nullable: false),
                    recipient_tenant_policy_version_id = table.Column<Guid>(type: "uuid", nullable: true),
                    recipient_snapshotted_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    provider_code = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    profile_code = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    provider_api_revision = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    ...
                    active_scope_key = table.Column<string>(type: "character varying(170)", maxLength: 170, nullable: false),
                    ...
                    last_status_observed_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    last_provider_request_id = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: true),
                    dispatch_pending_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    requires_action_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_payment_attempts_payment_attempt_statuses_authoritative_sta",
                    ...
                    table.ForeignKey(
                        name: "fk_payment_attempts_payment_attempt_statuses_payment_attempt_s",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_payment_attempts_registration_orders_tenant_id_registration",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_checkout_dispatch_effects_payment_attempts_tenant_id_paymen",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_payment_attempts_tenant_id_registration_order_id_payment_at",
                schema: "islamu_event",
                table: "payment_attempts",
