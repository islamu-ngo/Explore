        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    requirements_completed_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    subject_consent_record_id = table.Column<Guid>(type: "uuid", nullable: true),
                    subject_consent_granted_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    consent_required = table.Column<bool>(type: "boolean", nullable: false),
                    approval_required = table.Column<bool>(type: "boolean", nullable: false),
                    approved_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    approved_by_actor_id = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_participant_admission_eligibilities_registration_consent_re",
                    ...
                    table.ForeignKey(
                        name: "fk_participant_admission_eligibilities_registration_participan",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_participant_admission_eligibilities_registration_ticket_ass",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_participant_admission_eligibilities_tenant_id_registration_",
                schema: "islamu_event",
                table: "participant_admission_eligibilities",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_participant_admission_eligibilities_tenant_id_registration_1",
                schema: "islamu_event",
                table: "participant_admission_eligibilities",
                columns: new[] { "tenant_id", "registration_order_id", "participant_id" });

            migrationBuilder.CreateIndex(
                name: "ix_participant_admission_eligibilities_tenant_id_registration_2",
                schema: "islamu_event",
                table: "participant_admission_eligibilities",
                columns: new[] { "tenant_id", "registration_order_id", "registration_ticket_assignment_id", "registration_order_line_id" });

            migrationBuilder.CreateIndex(
                name: "ix_participant_admission_eligibilities_tenant_id_subject_conse",
                schema: "islamu_event",
                table: "participant_admission_eligibilities",
