        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    replacement_payment_attempt_id = table.Column<Guid>(type: "uuid", nullable: false),
                    reserved_refund_attempt_id = table.Column<Guid>(type: "uuid", nullable: false),
                    original_payment_allocation_id = table.Column<Guid>(type: "uuid", nullable: false),
                    stable_operation_id = table.Column<Guid>(type: "uuid", nullable: false),
                    refund_intent_id = table.Column<Guid>(type: "uuid", nullable: false),
                    provider_idempotency_key = table.Column<string>(type: "character varying(200)", unicode: false, maxLength: 200, nullable: false),
                    replacement_payment_settled_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_waitlist_payment_intents_fair_return_source_bindings_tenant",
                    ...
                    table.ForeignKey(
                        name: "fk_waitlist_payment_intents_payment_attempts_tenant_id_replace",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_waitlist_payment_intents_refund_attempts_tenant_id_reserved",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    tenant_id = table.Column<Guid>(type: "uuid", nullable: false),
                    waitlist_payment_intent_id = table.Column<Guid>(type: "uuid", nullable: false),
                    stable_operation_id = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    lease_owner = table.Column<string>(type: "character varying(64)", unicode: false, maxLength: 64, nullable: true),
                    ...
                    last_failure_code = table.Column<string>(type: "character varying(64)", unicode: false, maxLength: 64, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_fair_return_orchestration_effects_waitlist_payment_intents_",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_fair_return_orchestration_effects_status_id_next_attempt_at",
                schema: "islamu_event",
                table: "fair_return_orchestration_effects",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_fair_return_orchestration_effects_tenant_id_stable_operatio",
                schema: "islamu_event",
                table: "fair_return_orchestration_effects",
                columns: new[] { "tenant_id", "stable_operation_id" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_fair_return_orchestration_effects_tenant_id_waitlist_paymen",
                schema: "islamu_event",
                table: "fair_return_orchestration_effects",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_waitlist_payment_intents_tenant_id_fair_return_source_bindi",
                schema: "islamu_event",
                table: "waitlist_payment_intents",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_waitlist_payment_intents_tenant_id_replacement_payment_atte",
                schema: "islamu_event",
                table: "waitlist_payment_intents",
                columns: new[] { "tenant_id", "replacement_payment_attempt_id" });

            migrationBuilder.CreateIndex(
                name: "ix_waitlist_payment_intents_tenant_id_reserved_refund_attempt_",
                schema: "islamu_event",
                table: "waitlist_payment_intents",
            ...
            migrationBuilder.AddForeignKey(
                name: "fk_waitlist_refund_intents_refund_attempts_tenant_id_refund_at",
                schema: "islamu_event",
                table: "waitlist_refund_intents",
                columns: new[] { "tenant_id", "refund_attempt_id" },
                principalSchema: "islamu_event",
