// ABOUTME: Maps stable organizer claim status lookup rows without model-owned seed data.
...
public sealed class EventOrganizerClaimStatusConfiguration : IEntityTypeConfiguration<EventOrganizerClaimStatus>
{
