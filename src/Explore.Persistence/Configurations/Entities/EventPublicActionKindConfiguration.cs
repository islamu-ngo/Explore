// ABOUTME: Maps stable public event action kind lookup rows without model-owned seed data.
...
public sealed class EventPublicActionKindConfiguration : IEntityTypeConfiguration<EventPublicActionKind>
{
