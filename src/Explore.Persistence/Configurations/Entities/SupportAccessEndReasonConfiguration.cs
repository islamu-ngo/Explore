...
public class SupportAccessEndReasonConfiguration : IEntityTypeConfiguration<SupportAccessEndReason>
{
    public void Configure(EntityTypeBuilder<SupportAccessEndReason> builder)
    {
