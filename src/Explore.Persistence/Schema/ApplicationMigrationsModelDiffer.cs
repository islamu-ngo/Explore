...
// ABOUTME: Preserves monetary/admission snapshots and seeds required address-governance FK principals during scaffolding.
        ...
        commandBatchPreparerDependencies)
{
        ...
        List<MigrationOperation> operations)
    {
        int insertAfter = operations.FindIndex(operation =>
            ...
            && IsCanonicalTable(addColumn.Table, "ticket_type_entitlements"));
        if (insertAfter < 0
        ...
        string sql = $"UPDATE {qualifiedTable} SET scope_id = "
