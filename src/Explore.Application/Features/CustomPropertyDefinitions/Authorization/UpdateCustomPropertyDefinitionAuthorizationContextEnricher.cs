// ABOUTME: Resolves persisted tenant authorization context for shared custom-property definition updates.
...
namespace Explore.Application.Features.CustomPropertyDefinitions.Authorization;

public sealed class UpdateCustomPropertyDefinitionAuthorizationContextEnricher(
    ICustomPropertyDefinitionRepository repository,
    ITenantContext? tenantContext = null)
    : IAuthorizationContextEnricher<UpdateCustomPropertyDefinitionCommand>
{
    public async Task<AuthorizationContext> ResolveAsync(
        UpdateCustomPropertyDefinitionCommand request,
