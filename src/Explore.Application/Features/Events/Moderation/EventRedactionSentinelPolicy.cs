...
public static class EventRedactionSentinelPolicy
{
    ...
    [
        ...
        new("Event", "EventUrl", EventRedactionValueKind.Null, 2048, false, "External URL can identify the event."),
        ...
        new("EventSession", "CurrencyCode", EventRedactionValueKind.Null, 3, false, "Short constrained code; clear rather than force display sentinel."),
