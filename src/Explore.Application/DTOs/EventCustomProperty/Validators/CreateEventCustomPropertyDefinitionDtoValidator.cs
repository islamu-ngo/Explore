...
public class CreateEventCustomPropertyDefinitionDtoValidator : AbstractValidator<CreateEventCustomPropertyDefinitionDto>
{
    public CreateEventCustomPropertyDefinitionDtoValidator()
    {
        RuleFor(x => x.EventId)
        ...
        RuleForEach(x => x.Options)
            .SetValidator(new CreateEventCustomPropertyOptionDtoValidator());
    ...
    private static bool HaveMatchingDefaultShape(CreateEventCustomPropertyDefinitionDto dto)
    {
