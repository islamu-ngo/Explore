...
{
    private IReadOnlyList<CreateEventTemplateOptionDto>? _options = Array.AsReadOnly(Array.Empty<CreateEventTemplateOptionDto>());
    ...
    public IReadOnlyList<CreateEventTemplateOptionDto> Options
    {
        get => _options!;
