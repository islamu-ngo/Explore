...
{
    private IReadOnlyList<CustomPropertyOptionDto>? _options = Array.AsReadOnly(Array.Empty<CustomPropertyOptionDto>());
    ...
    public IReadOnlyList<CustomPropertyOptionDto> Options
    {
        get => _options!;
