...
{
    private IReadOnlyList<EventSessionCustomPropertyOptionDto>? _options = Array.AsReadOnly(Array.Empty<EventSessionCustomPropertyOptionDto>());
    ...
    public IReadOnlyList<EventSessionCustomPropertyOptionDto> Options
    {
        get => _options!;
