// ABOUTME: Session-local option row for a materialized custom-property definition.
...
public class EventSessionCustomPropertyOption : IAuditableEntity, ISoftDeletable, IConcurrencyAware
{
    ...
    public EventSessionCustomPropertyOption? ParentOption { get; set; }
    ...
    private readonly List<EventSessionCustomPropertyOption> _childOptions = [];
    public IReadOnlyCollection<EventSessionCustomPropertyOption> ChildOptions => _childOptions.AsReadOnly();
}
