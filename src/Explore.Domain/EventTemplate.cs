...
public class EventTemplate : ITenantEntity, IAuditableEntity, ISoftDeletable, IConcurrencyAware
{
    ...
    internal void ReplaceDefinitions(IEnumerable<EventTemplateCustomPropertyDefinition> definitions)
    {
        _definitions.Clear();
