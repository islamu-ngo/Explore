    ...
    private static IReadOnlyList<AiProposedActionCandidate> BuildProposedActions(AiChatPayload request)
    {
        ...
        [
            new AiProposedActionCandidate(
                ...
                $"{{\"title\":\"Fake AI event draft\",\"description\":\"Generated by the deterministic fake AI provider.\",\"participationConfiguration\":{{\"participationHandlingModeId\":{(int)ParticipationHandlingModeEnum.InformationOnly},\"advanceRegistrationObligationId\":{(int)AdvanceRegistrationObligationEnum.NotApplicable}}}}}",
