        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    active_uniqueness_slot = table.Column<string>(type: "TEXT", maxLength: 48, nullable: false),
                    status_id = table.Column<int>(type: "INTEGER", nullable: false),
                    merchant_country_code = table.Column<string>(type: "TEXT", maxLength: 2, nullable: true),
                    charge_capability_state_id = table.Column<int>(type: "INTEGER", nullable: false),
                    requirements_state_id = table.Column<int>(type: "INTEGER", nullable: false),
                    last_readiness_observed_at = table.Column<DateTime>(type: "TEXT", nullable: true),
                    last_readiness_evidence_revision = table.Column<string>(type: "TEXT", maxLength: 120, nullable: true),
                    replaces_connection_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    replaced_by_connection_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    replaced_at = table.Column<DateTime>(type: "TEXT", nullable: true),
                    disabled_at = table.Column<DateTime>(type: "TEXT", nullable: true),
                    disabled_reason_code = table.Column<string>(type: "TEXT", maxLength: 80, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_ie_organizer_payment_provider_connections_ie_actors_organizer_actor_id",
                        column: x => x.organizer_actor_id,
                        principalTable: "ie_actors",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_ie_organizer_payment_provider_connections_tenants_tenant_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    policy_scope_key = table.Column<string>(type: "TEXT", maxLength: 48, nullable: false),
                    version_number = table.Column<int>(type: "INTEGER", nullable: false),
                    is_active = table.Column<bool>(type: "INTEGER", nullable: false),
                    active_uniqueness_slot = table.Column<int>(type: "INTEGER", nullable: false),
                    is_payments_enabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    requires_local_verification = table.Column<bool>(type: "INTEGER", nullable: false),
                    default_currency_code = table.Column<string>(type: "TEXT", maxLength: 3, nullable: true),
                    requires_first_paid_event_review = table.Column<bool>(type: "INTEGER", nullable: false),
                    far_future_review_threshold_days = table.Column<int>(type: "INTEGER", nullable: true),
                    created_at = table.Column<DateTime>(type: "TEXT", nullable: false),
                    created_by = table.Column<Guid>(type: "TEXT", nullable: true),
                    updated_at = table.Column<DateTime>(type: "TEXT", nullable: true),
                    updated_by = table.Column<Guid>(type: "TEXT", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    tenant_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    organizer_payment_provider_connection_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    ordinal = table.Column<int>(type: "INTEGER", nullable: false),
                    currency_code = table.Column<string>(type: "TEXT", maxLength: 3, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_ie_organizer_payment_provider_connection_supported_currencies", x => new { x.tenant_id, x.organizer_payment_provider_connection_id, x.ordinal });
                    table.ForeignKey(
                        name: "fk_ie_organizer_payment_provider_connection_supported_currencies_ie_organizer_payment_provider_connections_tenant_id_organizer_payment_provider_connection_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_ie_paid_event_policy_allowed_currencies", x => new { x.policy_scope_key, x.paid_event_policy_version_id, x.ordinal });
                    table.ForeignKey(
                        name: "fk_ie_paid_event_policy_allowed_currencies_paid_event_policy_versions_policy_scope_key_paid_event_policy_version_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_ie_paid_event_policy_allowed_organizer_kinds", x => new { x.policy_scope_key, x.paid_event_policy_version_id, x.ordinal });
                    table.ForeignKey(
                        name: "fk_ie_paid_event_policy_allowed_organizer_kinds_paid_event_policy_versions_policy_scope_key_paid_event_policy_version_id",
                        columns: x => new { x.policy_scope_key, x.paid_event_policy_version_id },
                        principalTable: "ie_paid_event_policy_versions",
                        principalColumns: new[] { "policy_scope_key", "id" },
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_ie_paid_event_policy_currency_risk_limits", x => new { x.policy_scope_key, x.paid_event_policy_version_id, x.ordinal });
                    table.ForeignKey(
                        name: "fk_ie_paid_event_policy_currency_risk_limits_paid_event_policy_versions_policy_scope_key_paid_event_policy_version_id",
                        columns: x => new { x.policy_scope_key, x.paid_event_policy_version_id },
                        principalTable: "ie_paid_event_policy_versions",
                        principalColumns: new[] { "policy_scope_key", "id" },
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ordinal = table.Column<int>(type: "INTEGER", nullable: false),
                    tenant_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    refund_protection_id = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_ie_paid_event_policy_refund_protections", x => new { x.policy_scope_key, x.paid_event_policy_version_id, x.ordinal });
                    table.ForeignKey(
                        name: "fk_ie_paid_event_policy_refund_protections_paid_event_policy_versions_policy_scope_key_paid_event_policy_version_id",
                        columns: x => new { x.policy_scope_key, x.paid_event_policy_version_id },
                        principalTable: "ie_paid_event_policy_versions",
                        principalColumns: new[] { "policy_scope_key", "id" },
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_ie_organizer_payment_provider_connection_supported_currencies_tenant_id_organizer_payment_provider_connection_id_currency_code",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_ie_organizer_payment_provider_connections_active_scope_key_active_uniqueness_slot",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_ie_organizer_payment_provider_connections_provider_code_connect_platform_id_external_account_id",
                table: "ie_organizer_payment_provider_connections",
                columns: new[] { "provider_code", "connect_platform_id", "external_account_id" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ix_ie_organizer_payment_provider_connections_tenant_id_organizer_actor_id_provider_code_connect_platform_id_status_id",
                table: "ie_organizer_payment_provider_connections",
                columns: new[] { "tenant_id", "organizer_actor_id", "provider_code", "connect_platform_id", "status_id" });

            migrationBuilder.CreateIndex(
                name: "ix_ie_organizer_payment_provider_connections_tenant_id_replaced_by_connection_id",
                table: "ie_organizer_payment_provider_connections",
                columns: new[] { "tenant_id", "replaced_by_connection_id" });

            migrationBuilder.CreateIndex(
                name: "ix_ie_organizer_payment_provider_connections_tenant_id_replaces_connection_id",
                table: "ie_organizer_payment_provider_connections",
                columns: new[] { "tenant_id", "replaces_connection_id" });

            migrationBuilder.CreateIndex(
                name: "ix_ie_paid_event_policy_allowed_currencies_policy_scope_key_paid_event_policy_version_id_currency_code",
                table: "ie_paid_event_policy_allowed_currencies",
                columns: new[] { "policy_scope_key", "paid_event_policy_version_id", "currency_code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ix_ie_paid_event_policy_allowed_organizer_kinds_policy_scope_key_paid_event_policy_version_id_actor_type_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_ie_paid_event_policy_currency_risk_limits_policy_scope_key_paid_event_policy_version_id_currency_code",
                table: "ie_paid_event_policy_currency_risk_limits",
                columns: new[] { "policy_scope_key", "paid_event_policy_version_id", "currency_code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ix_ie_paid_event_policy_refund_protections_policy_scope_key_paid_event_policy_version_id_refund_protection_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_ie_paid_event_policy_versions_policy_scope_key_active_uniqueness_slot",
