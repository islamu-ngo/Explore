        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    event_day_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    event_session_id = table.Column<Guid>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_ie_admission_targets_event_days_tenant_id_event_id_event_day_id",
                    ...
                    table.ForeignKey(
                        name: "fk_ie_admission_targets_event_sessions_tenant_id_event_id_event_session_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<Guid>(type: "TEXT", nullable: false),
                    tenant_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    admission_target_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    opens_at_utc = table.Column<DateTime>(type: "TEXT", nullable: false),
                    closes_at_utc = table.Column<DateTime>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_ie_admission_check_in_policies_admission_targets_tenant_id_admission_target_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<Guid>(type: "TEXT", nullable: false),
                    tenant_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    issue_request_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    event_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    admission_target_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    lookup_key_version = table.Column<int>(type: "INTEGER", nullable: false),
                    lookup_digest = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    device_label = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    actions = table.Column<int>(type: "INTEGER", nullable: false),
                    expires_at = table.Column<DateTime>(type: "TEXT", nullable: false),
                    issued_by_actor_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    ...
                    revocation_reason = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    concurrency_stamp = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_ie_admission_scanner_capabilities_admission_targets_tenant_id_event_id_admission_target_id",
                        columns: x => new { x.tenant_id, x.event_id, x.admission_target_id },
                        principalTable: "ie_admission_targets",
                        principalColumns: new[] { "tenant_id", "event_id", "id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_ie_admission_scanner_capabilities_events_tenant_id_event_id",
                        columns: x => new { x.tenant_id, x.event_id },
                        principalTable: "ie_events",
                        principalColumns: new[] { "tenant_id", "id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_ie_admission_scanner_capabilities_ie_actors_issued_by_actor_id",
                        column: x => x.issued_by_actor_id,
                        principalTable: "ie_actors",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_ie_admission_scanner_capabilities_ie_actors_revoked_by_actor_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    scanner_capability_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    ...
                    compensated_check_in_event_id = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_ie_admission_check_in_events_admission_scanner_capabilities_tenant_id_scanner_capability_id",
                        columns: x => new { x.tenant_id, x.scanner_capability_id },
                        principalTable: "ie_admission_scanner_capabilities",
                        principalColumns: new[] { "tenant_id", "id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_ie_admission_check_in_events_admission_targets_tenant_id_admission_target_id",
                        columns: x => new { x.tenant_id, x.admission_target_id },
                        principalTable: "ie_admission_targets",
                        principalColumns: new[] { "tenant_id", "id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_ie_admission_check_in_events_admission_tickets_tenant_id_admission_ticket_id",
                        columns: x => new { x.tenant_id, x.admission_ticket_id },
                        principalTable: "ie_admission_tickets",
                        principalColumns: new[] { "tenant_id", "id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_ie_admission_check_in_events_ie_admission_check_in_events_tenant_id_admission_ticket_id_admission_target_id_compensated_check_in_event_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    admission_ticket_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    admission_target_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    active_check_in_event_id = table.Column<Guid>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_ie_admission_check_in_states_admission_targets_tenant_id_admission_target_id",
                        columns: x => new { x.tenant_id, x.admission_target_id },
                        principalTable: "ie_admission_targets",
                        principalColumns: new[] { "tenant_id", "id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_ie_admission_check_in_states_admission_tickets_tenant_id_admission_ticket_id",
                        columns: x => new { x.tenant_id, x.admission_ticket_id },
                        principalTable: "ie_admission_tickets",
                        principalColumns: new[] { "tenant_id", "id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_ie_admission_check_in_states_ie_admission_check_in_events_tenant_id_admission_ticket_id_admission_target_id_active_check_in_event_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_ie_admission_check_in_events_tenant_id_admission_ticket_id_admission_target_id_compensated_check_in_event_id",
                table: "ie_admission_check_in_events",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_ie_admission_check_in_states_tenant_id_admission_ticket_id_admission_target_id_active_check_in_event_id",
                table: "ie_admission_check_in_states",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_ie_admission_scanner_capabilities_tenant_id_event_id_admission_target_id",
                table: "ie_admission_scanner_capabilities",
