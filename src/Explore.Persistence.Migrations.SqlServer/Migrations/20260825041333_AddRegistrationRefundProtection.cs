        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    provider_dispute_id = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_payment_disputes_payment_attempts_tenant_id_payment_attempt_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    status = table.Column<int>(type: "int", nullable: false),
                    decision_reason = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    decision_at = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ...
                    processing_lease_owner = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    source_campaign_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    reservation_source_key = table.Column<string>(type: "nvarchar(48)", maxLength: 48, nullable: false),
                    authority_code = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    ...
                    status = table.Column<int>(type: "int", nullable: false),
                    provider_refund_id = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    last_provider_request_id = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
                    failure_code = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
                    buyer_refund_succeeded_at = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_refund_attempts_paid_order_acceptance_snapshots_tenant_id_paid_order_acceptance_snapshot_id",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_refund_attempts_payment_attempts_tenant_id_payment_attempt_id",
                        columns: x => new { x.tenant_id, x.payment_attempt_id },
                        principalSchema: "islamu_event",
                        principalTable: "payment_attempts",
                        principalColumns: new[] { "tenant_id", "id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_refund_attempts_refund_campaigns_tenant_id_source_campaign_id",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_refund_attempts_registration_orders_tenant_id_registration_order_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    tenant_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    refund_campaign_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    payment_attempt_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    registration_order_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    paid_order_acceptance_snapshot_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    status = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_registration_material_change_choices_paid_order_acceptance_snapshots_tenant_id_paid_order_acceptance_snapshot_id",
                        columns: x => new { x.tenant_id, x.paid_order_acceptance_snapshot_id },
                        principalSchema: "islamu_event",
                        principalTable: "paid_order_acceptance_snapshots",
                        principalColumns: new[] { "tenant_id", "id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_registration_material_change_choices_payment_attempts_tenant_id_payment_attempt_id",
                        columns: x => new { x.tenant_id, x.payment_attempt_id },
                        principalSchema: "islamu_event",
                        principalTable: "payment_attempts",
                        principalColumns: new[] { "tenant_id", "id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_registration_material_change_choices_refund_campaigns_tenant_id_refund_campaign_id",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    tenant_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    refund_attempt_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_refund_line_allocations_paid_order_acceptance_lines_tenant_id_paid_order_acceptance_snapshot_id_order_line_id",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_refund_line_allocations_refund_attempts_tenant_id_refund_attempt_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_refund_attempts_tenant_id_provider_code_external_account_id_provider_refund_id",
                schema: "islamu_event",
                table: "refund_attempts",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_refund_attempts_tenant_id_reservation_source_key_payment_attempt_id_paid_order_acceptance_snapshot_id",
                schema: "islamu_event",
                table: "refund_attempts",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_refund_campaigns_status_processing_lease_expires_at_decision_at_id",
                schema: "islamu_event",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_refund_line_allocations_tenant_id_paid_order_acceptance_snapshot_id_order_line_id",
                schema: "islamu_event",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_registration_material_change_choices_tenant_id_paid_order_acceptance_snapshot_id",
                schema: "islamu_event",
                table: "registration_material_change_choices",
                columns: new[] { "tenant_id", "paid_order_acceptance_snapshot_id" });

            migrationBuilder.CreateIndex(
                name: "ix_registration_material_change_choices_tenant_id_payment_attempt_id",
                schema: "islamu_event",
                table: "registration_material_change_choices",
                columns: new[] { "tenant_id", "payment_attempt_id" });

            migrationBuilder.CreateIndex(
                name: "ix_registration_material_change_choices_tenant_id_refund_campaign_id_payment_attempt_id_paid_order_acceptance_snapshot_id",
                schema: "islamu_event",
                table: "registration_material_change_choices",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_registration_material_change_choices_tenant_id_registration_order_id_status",
                schema: "islamu_event",
                table: "registration_material_change_choices",
