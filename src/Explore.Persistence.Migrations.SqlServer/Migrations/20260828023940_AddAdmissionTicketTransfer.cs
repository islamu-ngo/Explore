        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    open_admission_ticket_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    to_participant_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    recipient_subject_user_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    offer_operation_key = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    capability_digest = table.Column<string>(type: "nchar(44)", fixedLength: true, maxLength: 44, nullable: false),
                    ...
                    capability_consumed_at = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_admission_ticket_transfers_admission_tickets_tenant_id_admission_ticket_id",
                    ...
                    table.ForeignKey(
                        name: "fk_admission_ticket_transfers_registration_participants_tenant_id_registration_order_id_from_participant_id",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_admission_ticket_transfers_registration_participants_tenant_id_registration_order_id_to_participant_id",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_admission_ticket_transfers_registration_ticket_assignments_tenant_id_registration_order_id_registration_ticket_assignment_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_ticket_transfer_policies_event_ticket_catalog_versions_tenant_id_ticket_catalog_version_id",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_ticket_transfer_policies_event_ticket_types_tenant_id_event_ticket_type_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    tenant_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    admission_ticket_transfer_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_admission_transfer_delivery_intents_admission_ticket_transfers_tenant_id_admission_ticket_transfer_id",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_admission_transfer_delivery_intents_outbox_messages_outbox_message_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_admission_ticket_transfers_tenant_id_registration_order_id_from_participant_id",
                schema: "islamu_event",
                table: "admission_ticket_transfers",
                columns: new[] { "tenant_id", "registration_order_id", "from_participant_id" });

            migrationBuilder.CreateIndex(
                name: "ix_admission_ticket_transfers_tenant_id_registration_order_id_registration_ticket_assignment_id_registration_order_line_id",
                schema: "islamu_event",
                table: "admission_ticket_transfers",
                columns: new[] { "tenant_id", "registration_order_id", "registration_ticket_assignment_id", "registration_order_line_id" });

            migrationBuilder.CreateIndex(
                name: "ix_admission_ticket_transfers_tenant_id_registration_order_id_to_participant_id",
                schema: "islamu_event",
                table: "admission_ticket_transfers",
