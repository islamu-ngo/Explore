        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    recovery_request_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    locator_digest = table.Column<string>(type: "nchar(44)", fixedLength: true, maxLength: 44, nullable: false),
                    expires_at = table.Column<DateTime>(type: "datetime2", nullable: false),
                    consumed_at = table.Column<DateTime>(type: "datetime2", nullable: true),
                    rotated_at = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_admission_recovery_capabilities_admission_tickets_tenant_id_admission_ticket_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    purpose = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    capability_version = table.Column<int>(type: "int", nullable: false),
                    protected_material = table.Column<string>(type: "nvarchar(max)", maxLength: 4096, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_admission_recovery_delivery_intents_admission_tickets_tenant_id_admission_ticket_id",
                        columns: x => new { x.tenant_id, x.admission_ticket_id },
                        principalSchema: "islamu_event",
                        principalTable: "admission_tickets",
                        principalColumns: new[] { "tenant_id", "id" },
            ...
            migrationBuilder.CreateIndex(
                name: "ix_admission_recovery_delivery_intents_tenant_id_admission_ticket_id",
                schema: "islamu_event",
                table: "admission_recovery_delivery_intents",
