        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    api_version = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    kind = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    manifest_name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    digest = table.Column<string>(type: "nchar(64)", fixedLength: true, maxLength: 64, nullable: false),
                    instance_section_digest = table.Column<string>(type: "nchar(64)", fixedLength: true, maxLength: 64, nullable: true),
                    ...
                    instance_changed_document_key_names = table.Column<string>(type: "nvarchar(max)", maxLength: 4096, nullable: false),
                    instance_changed_setting_key_names = table.Column<string>(type: "nvarchar(max)", maxLength: 4096, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    completed_at = table.Column<DateTime>(type: "datetime2", nullable: false),
                    changed_document_key_names = table.Column<string>(type: "nvarchar(max)", maxLength: 4096, nullable: false),
                    changed_setting_key_names = table.Column<string>(type: "nvarchar(max)", maxLength: 4096, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_configuration_manifest_tenant_results", x => x.id);
                    table.ForeignKey(
                        name: "fk_configuration_manifest_tenant_results_configuration_manifest_operations_operation_id",
