        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    master_code = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    display_reference = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    last_transition_at = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_admission_tickets_admission_ticket_statuses_admission_ticket_status_id",
                    ...
                    table.ForeignKey(
                        name: "fk_admission_tickets_admission_ticket_transition_reasons_last_transition_reason_id",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_admission_tickets_event_ticket_catalog_versions_tenant_id_ticket_catalog_version_id",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_admission_tickets_event_ticket_types_tenant_id_event_ticket_type_id",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_admission_tickets_registration_order_lines_tenant_id_registration_order_id_registration_order_line_id",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_admission_tickets_registration_orders_tenant_id_event_id_registration_order_id",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_admission_tickets_registration_participants_tenant_id_registration_order_id_participant_id",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_admission_tickets_registration_ticket_assignments_tenant_id_registration_order_id_registration_ticket_assignment_id_registra",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    tenant_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    finalization_effect_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    registration_ticket_assignment_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    admission_ticket_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    protected_credential = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: false),
                    protection_version = table.Column<int>(type: "int", nullable: false),
                    created_at = table.Column<DateTime>(type: "datetime2", nullable: false),
                    routed_at = table.Column<DateTime>(type: "datetime2", nullable: true),
                    handoff_completed_at = table.Column<DateTime>(type: "datetime2", nullable: true),
                    handoff_receipt_id = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    concurrency_stamp = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_admission_delivery_intents_admission_tickets_tenant_id_admission_ticket_id",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_admission_delivery_intents_registration_finalization_effects_tenant_id_finalization_effect_id",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_admission_delivery_intents_registration_ticket_assignments_tenant_id_registration_ticket_assignment_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    lookup_digest = table.Column<string>(type: "nchar(44)", fixedLength: true, maxLength: 44, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_admission_ticket_credentials_admission_ticket_credential_statuses_admission_ticket_credential_status_id",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_admission_ticket_credentials_admission_tickets_tenant_id_admission_ticket_id",
                        columns: x => new { x.tenant_id, x.admission_ticket_id },
                        principalSchema: "islamu_event",
                        principalTable: "admission_tickets",
                        principalColumns: new[] { "tenant_id", "id" },
            ...
            migrationBuilder.CreateIndex(
                name: "ix_admission_delivery_intents_tenant_id_registration_ticket_assignment_id",
                schema: "islamu_event",
                table: "admission_delivery_intents",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_admission_ticket_credentials_admission_ticket_credential_status_id",
                schema: "islamu_event",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_admission_tickets_tenant_id_registration_order_id_participant_id",
                schema: "islamu_event",
                table: "admission_tickets",
                columns: new[] { "tenant_id", "registration_order_id", "participant_id" });

            migrationBuilder.CreateIndex(
                name: "ix_admission_tickets_tenant_id_registration_order_id_registration_order_line_id",
                schema: "islamu_event",
                table: "admission_tickets",
                columns: new[] { "tenant_id", "registration_order_id", "registration_order_line_id" });

            migrationBuilder.CreateIndex(
                name: "ix_admission_tickets_tenant_id_registration_order_id_registration_ticket_assignment_id_registration_order_line_id",
                schema: "islamu_event",
                table: "admission_tickets",
