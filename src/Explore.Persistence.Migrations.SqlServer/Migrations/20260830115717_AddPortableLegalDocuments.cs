        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    authority_key = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
                    ...
                    accountable_identity_reference = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    legal_document_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    version = table.Column<int>(type: "int", nullable: false),
                    audience = table.Column<int>(type: "int", nullable: false),
                    state = table.Column<int>(type: "int", nullable: false),
                    content_digest = table.Column<string>(type: "varchar(64)", unicode: false, maxLength: 64, nullable: false),
                    source_origin = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    requires_fresh_acceptance = table.Column<bool>(type: "bit", nullable: false),
                    template_id = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    template_version = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    template_source_kind = table.Column<int>(type: "int", nullable: true),
                    template_license_expression = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    template_review_reference = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    reviewer_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    review_evidence_reference = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    accountable_identity_reference = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    approved_at = table.Column<DateTime>(type: "datetime2", nullable: true),
                    proposed_effective_at = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    legal_document_version_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    language_tag = table.Column<string>(type: "varchar(35)", unicode: false, maxLength: 35, nullable: false),
                    title = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    summary = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    markdown = table.Column<string>(type: "nvarchar(max)", maxLength: 262144, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    content_digest = table.Column<string>(type: "varchar(64)", unicode: false, maxLength: 64, nullable: false),
                    accountable_identity_reference = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    review_evidence_reference = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
