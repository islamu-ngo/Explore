        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    enforcement_key = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    acting_account_user_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    purchaser_actor_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    order_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    supports_hard_cross_order_ceiling = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    tenant_policy_version_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    event_policy_version_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    authority_usage_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    key_hash = table.Column<string>(type: "nvarchar(44)", maxLength: 44, nullable: false),
                    fingerprint_hash = table.Column<string>(type: "nvarchar(44)", maxLength: 44, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_ticket_purchase_operations_ticket_purchase_authority_usages_tenant_id_event_id_authority_usage_id",
                    ...
                    table.ForeignKey(
                        name: "fk_ticket_purchase_operations_ticket_purchase_policy_versions_tenant_id_event_id_policy_version_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_ticket_purchase_authority_usages_tenant_id_event_id_enforcement_key",
                schema: "islamu_event",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_ticket_purchase_operations_tenant_id_event_id_authority_usage_id",
                schema: "islamu_event",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_ticket_purchase_operations_tenant_id_event_id_policy_version_id",
                schema: "islamu_event",
                table: "ticket_purchase_operations",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_ticket_purchase_policy_versions_tenant_id_event_id_instance_policy_version_id_tenant_policy_version_id_event_policy_version_",
                schema: "islamu_event",
                table: "ticket_purchase_policy_versions",
