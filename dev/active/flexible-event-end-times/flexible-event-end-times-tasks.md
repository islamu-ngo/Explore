...
- **Completed:** 0/9
- **Current priority:** Plan approval & baselining
- **Next recommended slice:** Phase 1 (Domain & Persistence Changes)
...
## Phase 1: Domain & Persistence Changes ⏳ NOT STARTED
- [ ] **1.1 Define `SessionEndTimeType` Enum**
  ...
  - **Effort:** S
- [ ] **1.2 Refactor Projection Calculator Contract and Models**
  ...
  - **Effort:** M
  - **Dependencies:** 1.1
- [ ] **1.3 Refactor `EventSession` properties and projections**
...
- [ ] **1.4 Update `EventSessionIslamicAspect` scheduling rules**
  ...
  - **Effort:** M
  - **Dependencies:** 1.1
- [ ] **1.5 Configure EF Mappings and PostgreSQL Check Constraints**
...
- [ ] **1.6 Generate EF Core migration**
...
## Phase 2: Application Layer & API Changes ⏳ NOT STARTED
- [ ] **2.1 Update DTO Contracts**
...
- [ ] **2.2 Refactor Validators**
  ...
  - **Effort:** M
  - **Dependencies:** 2.1
- [ ] **2.3 Update `EventLifecycleReadinessEvaluator`**
  ...
  - **Effort:** M
  - **Dependencies:** 2.1
- [ ] **2.4 Add Formatted End Time Resolution**
...
## Phase 3: Verification & Documentation ⏳ NOT STARTED
- [ ] **3.1 Run Verification Suite**
...
- [ ] `dotnet test --project Event.Domain.UnitTests/Event.Domain.UnitTests.csproj` passes.
- [ ] `dotnet test --project Event.Application.UnitTests/Event.Application.UnitTests.csproj` passes.
- [ ] `dotnet test --project Event.Persistence.IntegrationTests/Event.Persistence.IntegrationTests.csproj` passes.
- [ ] `dotnet test --project Event.Architecture.Tests/Event.Architecture.Tests.csproj` passes.
