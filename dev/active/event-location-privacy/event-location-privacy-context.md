...
- Corrected task ownership and execution order: ELP-420 is split into additive/final generation, ELP-505 and ELP-515 are one transaction lane, ELP-230C runs after every consumer migration, and Infrastructure/E2E verification are mandatory.
